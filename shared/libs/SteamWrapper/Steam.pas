...
const
  ...
  SteamNetworkingFakeIPResult_t__k_nMaxReturnPorts: Integer = Integer(8);
  k_uAppIdInvalid: AppId_t = AppId_t($0);
  k_uDepotIdInvalid: DepotId_t = DepotId_t($0);
  k_uAPICallInvalid: SteamAPICall_t = SteamAPICall_t($0);
  k_ulPartyBeaconIdInvalid: PartyBeaconID_t = PartyBeaconID_t(0);
  k_HAuthTicketInvalid: HAuthTicket = HAuthTicket(0);
  k_unSteamAccountIDMask: UInt32 = UInt32($FFFFFFFF);
  k_unSteamAccountInstanceMask: UInt32 = UInt32($000FFFFF);
  k_unSteamUserDefaultInstance: UInt32 = UInt32(1);
  k_cchGameExtraInfoMax: Integer = Integer(64);
  k_cchMaxFriendsGroupName: Integer = Integer(64);
  k_cFriendsGroupLimit: Integer = Integer(100);
  k_FriendsGroupID_Invalid: FriendsGroupID_t = FriendsGroupID_t(- 1);
  k_cEnumerateFollowersMax: Integer = Integer(50);
  k_cubChatMetadataMax: UInt32 = UInt32(8192);
  k_cbMaxGameServerGameDir: Integer = Integer(32);
  k_cbMaxGameServerMapName: Integer = Integer(32);
  k_cbMaxGameServerGameDescription: Integer = Integer(64);
  k_cbMaxGameServerName: Integer = Integer(64);
  k_cbMaxGameServerTags: Integer = Integer(128);
  k_cbMaxGameServerGameData: Integer = Integer(2048);
  HSERVERQUERY_INVALID: Integer = Integer($ffffffff);
  k_unFavoriteFlagNone: UInt32 = UInt32($00);
  k_unFavoriteFlagFavorite: UInt32 = UInt32($01);
  k_unFavoriteFlagHistory: UInt32 = UInt32($02);
  k_unMaxCloudFileChunkSize: UInt32 = UInt32(100 * 1024 * 1024);
  k_PublishedFileIdInvalid: PublishedFileId_t = PublishedFileId_t(0);
  k_UGCHandleInvalid: UGCHandle_t = UGCHandle_t($ffffffffffffffff);
  k_PublishedFileUpdateHandleInvalid: PublishedFileUpdateHandle_t = PublishedFileUpdateHandle_t($ffffffffffffffff);
  k_UGCFileStreamHandleInvalid: UGCFileWriteStreamHandle_t = UGCFileWriteStreamHandle_t($ffffffffffffffff);
  k_cchPublishedDocumentTitleMax: UInt32 = UInt32(128 + 1);
  k_cchPublishedDocumentDescriptionMax: UInt32 = UInt32(8000);
  k_cchPublishedDocumentChangeDescriptionMax: UInt32 = UInt32(8000);
  k_unEnumeratePublishedFilesMaxResults: UInt32 = UInt32(50);
  k_cchTagListMax: UInt32 = UInt32(1024 + 1);
  k_cchFilenameMax: UInt32 = UInt32(260);
  k_cchPublishedFileURLMax: UInt32 = UInt32(256);
  k_cubAppProofOfPurchaseKeyMax: Integer = Integer(240);
  k_nScreenshotMaxTaggedUsers: UInt32 = UInt32(32);
  k_nScreenshotMaxTaggedPublishedFiles: UInt32 = UInt32(32);
  k_cubUFSTagTypeMax: Integer = Integer(255);
  k_cubUFSTagValueMax: Integer = Integer(255);
  k_ScreenshotThumbWidth: Integer = Integer(200);
  k_UGCQueryHandleInvalid: UGCQueryHandle_t = UGCQueryHandle_t($ffffffffffffffff);
  k_UGCUpdateHandleInvalid: UGCUpdateHandle_t = UGCUpdateHandle_t($ffffffffffffffff);
  kNumUGCResultsPerPage: UInt32 = UInt32(50);
  k_cchDeveloperMetadataMax: UInt32 = UInt32(5000);
  INVALID_HTMLBROWSER: UInt32 = UInt32(0);
  k_SteamItemInstanceIDInvalid: SteamItemInstanceID_t = SteamItemInstanceID_t(not 0);
  k_SteamInventoryResultInvalid: SteamInventoryResult_t = SteamInventoryResult_t(- 1);
  k_SteamInventoryUpdateHandleInvalid: SteamInventoryUpdateHandle_t = SteamInventoryUpdateHandle_t($ffffffffffffffff);
  k_HSteamNetConnection_Invalid: HSteamNetConnection = HSteamNetConnection(0);
  k_HSteamListenSocket_Invalid: HSteamListenSocket = HSteamListenSocket(0);
  k_HSteamNetPollGroup_Invalid: HSteamNetPollGroup = HSteamNetPollGroup(0);
  k_cchMaxSteamNetworkingErrMsg: Integer = Integer(1024);
  k_cchSteamNetworkingMaxConnectionCloseReason: Integer = Integer(128);
  k_cchSteamNetworkingMaxConnectionDescription: Integer = Integer(128);
  k_cchSteamNetworkingMaxConnectionAppName: Integer = Integer(32);
  k_nSteamNetworkConnectionInfoFlags_Unauthenticated: Integer = Integer(1);
  k_nSteamNetworkConnectionInfoFlags_Unencrypted: Integer = Integer(2);
  k_nSteamNetworkConnectionInfoFlags_LoopbackBuffers: Integer = Integer(4);
  k_nSteamNetworkConnectionInfoFlags_Fast: Integer = Integer(8);
  k_nSteamNetworkConnectionInfoFlags_Relayed: Integer = Integer(16);
  k_nSteamNetworkConnectionInfoFlags_DualWifi: Integer = Integer(32);
  k_cbMaxSteamNetworkingSocketsMessageSizeSend: Integer = Integer(512 * 1024);
  k_nSteamNetworkingSend_Unreliable: Integer = Integer(0);
  k_nSteamNetworkingSend_NoNagle: Integer = Integer(1);
  k_nSteamNetworkingSend_UnreliableNoNagle: Integer = Integer(0 or 1);
  k_nSteamNetworkingSend_NoDelay: Integer = Integer(4);
  k_nSteamNetworkingSend_UnreliableNoDelay: Integer = Integer(0 or 4 or 1);
  k_nSteamNetworkingSend_Reliable: Integer = Integer(8);
  k_nSteamNetworkingSend_ReliableNoNagle: Integer = Integer(8 or 1);
  k_nSteamNetworkingSend_UseCurrentThread: Integer = Integer(16);
  k_nSteamNetworkingSend_AutoRestartBrokenSession: Integer = Integer(32);
  k_cchMaxSteamNetworkingPingLocationString: Integer = Integer(1024);
  k_nSteamNetworkingPing_Failed: Integer = Integer(- 1);
  k_nSteamNetworkingPing_Unknown: Integer = Integer(- 2);
  k_nSteamNetworkingConfig_P2P_Transport_ICE_Enable_Default: Integer = Integer(- 1);
  k_nSteamNetworkingConfig_P2P_Transport_ICE_Enable_Disable: Integer = Integer(0);
  k_nSteamNetworkingConfig_P2P_Transport_ICE_Enable_Relay: Integer = Integer(1);
  k_nSteamNetworkingConfig_P2P_Transport_ICE_Enable_Private: Integer = Integer(2);
  k_nSteamNetworkingConfig_P2P_Transport_ICE_Enable_Public: Integer = Integer(4);
  k_nSteamNetworkingConfig_P2P_Transport_ICE_Enable_All: Integer = Integer($7fffffff);
  k_SteamDatagramPOPID_dev: SteamNetworkingPOPID = SteamNetworkingPOPID(6579574);
  STEAMGAMESERVER_QUERY_PORT_SHARED: UInt16 = UInt16($ffff);
  MASTERSERVERUPDATERPORT_USEGAMESOCKETSHARE: UInt16 = UInt16($ffff);
  k_cbSteamDatagramMaxSerializedTicket: UInt32 = UInt32(512);
  k_cbMaxSteamDatagramGameCoordinatorServerLoginAppData: UInt32 = UInt32(2048);
  k_cbMaxSteamDatagramGameCoordinatorServerLoginSerialized: UInt32 = UInt32(4096);
  k_cbSteamNetworkingSocketsFakeUDPPortRecommendedMTU: Integer = Integer(1200);
  k_cbSteamNetworkingSocketsFakeUDPPortMaxMessageSize: Integer = Integer(4096);
  SteamNetworkingIPAddr__k_cchMaxString: Integer = Integer(48);
  SteamNetworkingIdentity__k_cchMaxString: Integer = Integer(128);
  SteamNetworkingIdentity__k_cchMaxGenericString: Integer = Integer(32);
  SteamNetworkingIdentity__k_cchMaxXboxPairwiseID: Integer = Integer(33);
  SteamNetworkingIdentity__k_cbMaxGenericBytes: Integer = Integer(32);
