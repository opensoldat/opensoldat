...
function SteamAPI_SteamIPAddress_t_IsSet(APSteamIPAddress_t: PSteamIPAddress_t): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_MatchMakingKeyValuePair_t_Construct(APMatchMakingKeyValuePair_t: PMatchMakingKeyValuePair_t); cdecl; external STEAMLIB;
procedure SteamAPI_servernetadr_t_Construct(APservernetadr_t: Pservernetadr_t); cdecl; external STEAMLIB;
procedure SteamAPI_servernetadr_t_Init(APservernetadr_t: Pservernetadr_t; ip: UInt32; usQueryPort: UInt16; usConnectionPort: UInt16); cdecl; external STEAMLIB;
function SteamAPI_servernetadr_t_GetQueryPort(APservernetadr_t: Pservernetadr_t): UInt16; cdecl; external STEAMLIB;
procedure SteamAPI_servernetadr_t_SetQueryPort(APservernetadr_t: Pservernetadr_t; usPort: UInt16); cdecl; external STEAMLIB;
function SteamAPI_servernetadr_t_GetConnectionPort(APservernetadr_t: Pservernetadr_t): UInt16; cdecl; external STEAMLIB;
procedure SteamAPI_servernetadr_t_SetConnectionPort(APservernetadr_t: Pservernetadr_t; usPort: UInt16); cdecl; external STEAMLIB;
function SteamAPI_servernetadr_t_GetIP(APservernetadr_t: Pservernetadr_t): UInt32; cdecl; external STEAMLIB;
procedure SteamAPI_servernetadr_t_SetIP(APservernetadr_t: Pservernetadr_t; unIP: UInt32); cdecl; external STEAMLIB;
function SteamAPI_servernetadr_t_GetConnectionAddressString(APservernetadr_t: Pservernetadr_t): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_servernetadr_t_GetQueryAddressString(APservernetadr_t: Pservernetadr_t): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_servernetadr_t_IsLessThan(APservernetadr_t: Pservernetadr_t; netadr: Pservernetadr_t): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_servernetadr_t_Assign(APservernetadr_t: Pservernetadr_t; that: Pservernetadr_t); cdecl; external STEAMLIB;
procedure SteamAPI_gameserveritem_t_Construct(APgameserveritem_t: Pgameserveritem_t); cdecl; external STEAMLIB;
function SteamAPI_gameserveritem_t_GetName(APgameserveritem_t: Pgameserveritem_t): PAnsiChar; cdecl; external STEAMLIB;
procedure SteamAPI_gameserveritem_t_SetName(APgameserveritem_t: Pgameserveritem_t; pName: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIPAddr_Clear(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIPAddr_IsIPv6AllZeros(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIPAddr_SetIPv6(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr; ipv6: PUInt8; nPort: UInt16); cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIPAddr_SetIPv4(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr; nIP: UInt32; nPort: UInt16); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIPAddr_IsIPv4(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr): Boolean; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIPAddr_GetIPv4(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr): UInt32; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIPAddr_SetIPv6LocalHost(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr; nPort: UInt16); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIPAddr_IsLocalHost(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIPAddr_ToString(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr; buf: PAnsiChar; cbBuf: UInt32; bWithPort: Boolean); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIPAddr_ParseString(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr; pszStr: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIPAddr_IsEqualTo(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr; x: PSteamNetworkingIPAddr): Boolean; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIPAddr_GetFakeIPType(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr): ESteamNetworkingFakeIPType; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIPAddr_IsFakeIP(APSteamNetworkingIPAddr: PSteamNetworkingIPAddr): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_Clear(APSteamNetworkingIdentity: PSteamNetworkingIdentity); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_IsInvalid(APSteamNetworkingIdentity: PSteamNetworkingIdentity): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_SetSteamID(APSteamNetworkingIdentity: PSteamNetworkingIdentity; steamID: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetSteamID(APSteamNetworkingIdentity: PSteamNetworkingIdentity): CSteamID; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_SetSteamID64(APSteamNetworkingIdentity: PSteamNetworkingIdentity; steamID: UInt64); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetSteamID64(APSteamNetworkingIdentity: PSteamNetworkingIdentity): UInt64; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_SetXboxPairwiseID(APSteamNetworkingIdentity: PSteamNetworkingIdentity; pszString: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetXboxPairwiseID(APSteamNetworkingIdentity: PSteamNetworkingIdentity): PAnsiChar; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_SetPSNID(APSteamNetworkingIdentity: PSteamNetworkingIdentity; id: UInt64); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetPSNID(APSteamNetworkingIdentity: PSteamNetworkingIdentity): UInt64; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_SetStadiaID(APSteamNetworkingIdentity: PSteamNetworkingIdentity; id: UInt64); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetStadiaID(APSteamNetworkingIdentity: PSteamNetworkingIdentity): UInt64; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_SetIPAddr(APSteamNetworkingIdentity: PSteamNetworkingIdentity; addr: PSteamNetworkingIPAddr); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetIPAddr(APSteamNetworkingIdentity: PSteamNetworkingIdentity): PSteamNetworkingIPAddr; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_SetIPv4Addr(APSteamNetworkingIdentity: PSteamNetworkingIdentity; nIPv4: UInt32; nPort: UInt16); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetIPv4(APSteamNetworkingIdentity: PSteamNetworkingIdentity): UInt32; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetFakeIPType(APSteamNetworkingIdentity: PSteamNetworkingIdentity): ESteamNetworkingFakeIPType; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_IsFakeIP(APSteamNetworkingIdentity: PSteamNetworkingIdentity): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_SetLocalHost(APSteamNetworkingIdentity: PSteamNetworkingIdentity); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_IsLocalHost(APSteamNetworkingIdentity: PSteamNetworkingIdentity): Boolean; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_SetGenericString(APSteamNetworkingIdentity: PSteamNetworkingIdentity; pszString: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetGenericString(APSteamNetworkingIdentity: PSteamNetworkingIdentity): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_SetGenericBytes(APSteamNetworkingIdentity: PSteamNetworkingIdentity; data: Pointer; cbLen: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_GetGenericBytes(APSteamNetworkingIdentity: PSteamNetworkingIdentity; cbLen: PInteger): PUInt8; cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_IsEqualTo(APSteamNetworkingIdentity: PSteamNetworkingIdentity; x: PSteamNetworkingIdentity): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingIdentity_ToString(APSteamNetworkingIdentity: PSteamNetworkingIdentity; buf: PAnsiChar; cbBuf: UInt32); cdecl; external STEAMLIB;
function SteamAPI_SteamNetworkingIdentity_ParseString(APSteamNetworkingIdentity: PSteamNetworkingIdentity; pszStr: PAnsiChar): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingMessage_t_Release(APSteamNetworkingMessage_t: PSteamNetworkingMessage_t); cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingConfigValue_t_SetInt32(APSteamNetworkingConfigValue_t: PSteamNetworkingConfigValue_t; eVal: ESteamNetworkingConfigValue; data: Int32); cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingConfigValue_t_SetInt64(APSteamNetworkingConfigValue_t: PSteamNetworkingConfigValue_t; eVal: ESteamNetworkingConfigValue; data: Int64); cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingConfigValue_t_SetFloat(APSteamNetworkingConfigValue_t: PSteamNetworkingConfigValue_t; eVal: ESteamNetworkingConfigValue; data: Single); cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingConfigValue_t_SetPtr(APSteamNetworkingConfigValue_t: PSteamNetworkingConfigValue_t; eVal: ESteamNetworkingConfigValue; data: Pointer); cdecl; external STEAMLIB;
procedure SteamAPI_SteamNetworkingConfigValue_t_SetString(APSteamNetworkingConfigValue_t: PSteamNetworkingConfigValue_t; eVal: ESteamNetworkingConfigValue; data: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_SteamDatagramHostedAddress_Clear(APSteamDatagramHostedAddress: PSteamDatagramHostedAddress); cdecl; external STEAMLIB;
function SteamAPI_SteamDatagramHostedAddress_GetPopID(APSteamDatagramHostedAddress: PSteamDatagramHostedAddress): SteamNetworkingPOPID; cdecl; external STEAMLIB;
procedure SteamAPI_SteamDatagramHostedAddress_SetDevAddress(APSteamDatagramHostedAddress: PSteamDatagramHostedAddress; nIP: UInt32; nPort: UInt16; popid: SteamNetworkingPOPID); cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_CreateSteamPipe(APISteamClient: PISteamClient): HSteamPipe; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_BReleaseSteamPipe(APISteamClient: PISteamClient; hSteamPipe: HSteamPipe): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_ConnectToGlobalUser(APISteamClient: PISteamClient; hSteamPipe: HSteamPipe): HSteamUser; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_CreateLocalUser(APISteamClient: PISteamClient; phSteamPipe: PHSteamPipe; eAccountType: EAccountType): HSteamUser; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamClient_ReleaseUser(APISteamClient: PISteamClient; hSteamPipe: HSteamPipe; hUser: HSteamUser); cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamUser(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamUser; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamGameServer(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamGameServer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamClient_SetLocalIPBinding(APISteamClient: PISteamClient; unIP: PSteamIPAddress_t; usPort: UInt16); cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamFriends(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamFriends; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamUtils(APISteamClient: PISteamClient; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamUtils; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamMatchmaking(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamMatchmaking; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamMatchmakingServers(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamMatchmakingServers; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamGenericInterface(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): Pointer; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamUserStats(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamUserStats; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamGameServerStats(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamGameServerStats; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamApps(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamApps; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamNetworking(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamNetworking; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamRemoteStorage(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamRemoteStorage; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamScreenshots(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamScreenshots; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamGameSearch(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamGameSearch; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetIPCCallCount(APISteamClient: PISteamClient): UInt32; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamClient_SetWarningMessageHook(APISteamClient: PISteamClient; pFunction: SteamAPIWarningMessageHook_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_BShutdownIfAllPipesClosed(APISteamClient: PISteamClient): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamHTTP(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamHTTP; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamController(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamController; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamUGC(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamUGC; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamAppList(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamAppList; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamMusic(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamMusic; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamMusicRemote(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamMusicRemote; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamHTMLSurface(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamHTMLSurface; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamInventory(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamInventory; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamVideo(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamVideo; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamParentalSettings(APISteamClient: PISteamClient; hSteamuser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamParentalSettings; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamInput(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamInput; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamParties(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamParties; cdecl; external STEAMLIB;
function SteamAPI_ISteamClient_GetISteamRemotePlay(APISteamClient: PISteamClient; hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: PAnsiChar): PISteamRemotePlay; cdecl; external STEAMLIB;

function SteamAPI_ISteamUser_GetHSteamUser(APISteamUser: PISteamUser): HSteamUser; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_BLoggedOn(APISteamUser: PISteamUser): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetSteamID(APISteamUser: PISteamUser): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_InitiateGameConnection_DEPRECATED(APISteamUser: PISteamUser; pAuthBlob: Pointer; cbMaxAuthBlob: Integer; steamIDGameServer: CSteamID; unIPServer: UInt32; usPortServer: UInt16; bSecure: Boolean): Integer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUser_TerminateGameConnection_DEPRECATED(APISteamUser: PISteamUser; unIPServer: UInt32; usPortServer: UInt16); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUser_TrackAppUsageEvent(APISteamUser: PISteamUser; gameID: CGameID; eAppUsageEvent: Integer; pchExtraInfo: PAnsiChar); cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetUserDataFolder(APISteamUser: PISteamUser; pchBuffer: PAnsiChar; cubBuffer: Integer): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUser_StartVoiceRecording(APISteamUser: PISteamUser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUser_StopVoiceRecording(APISteamUser: PISteamUser); cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetAvailableVoice(APISteamUser: PISteamUser; pcbCompressed: PUInt32; pcbUncompressed_Deprecated: PUInt32; nUncompressedVoiceDesiredSampleRate_Deprecated: UInt32): EVoiceResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetVoice(APISteamUser: PISteamUser; bWantCompressed: Boolean; pDestBuffer: Pointer; cbDestBufferSize: UInt32; nBytesWritten: PUInt32; bWantUncompressed_Deprecated: Boolean; pUncompressedDestBuffer_Deprecated: Pointer; cbUncompressedDestBufferSize_Deprecated: UInt32; nUncompressBytesWritten_Deprecated: PUInt32; nUncompressedVoiceDesiredSampleRate_Deprecated: UInt32): EVoiceResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_DecompressVoice(APISteamUser: PISteamUser; pCompressed: Pointer; cbCompressed: UInt32; pDestBuffer: Pointer; cbDestBufferSize: UInt32; nBytesWritten: PUInt32; nDesiredSampleRate: UInt32): EVoiceResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetVoiceOptimalSampleRate(APISteamUser: PISteamUser): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetAuthSessionTicket(APISteamUser: PISteamUser; pTicket: Pointer; cbMaxTicket: Integer; pcbTicket: PUInt32): HAuthTicket; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_BeginAuthSession(APISteamUser: PISteamUser; pAuthTicket: Pointer; cbAuthTicket: Integer; steamID: CSteamID): EBeginAuthSessionResult; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUser_EndAuthSession(APISteamUser: PISteamUser; steamID: CSteamID); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUser_CancelAuthTicket(APISteamUser: PISteamUser; hAuthTicket: HAuthTicket); cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_UserHasLicenseForApp(APISteamUser: PISteamUser; steamID: CSteamID; appID: AppId_t): EUserHasLicenseForAppResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_BIsBehindNAT(APISteamUser: PISteamUser): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUser_AdvertiseGame(APISteamUser: PISteamUser; steamIDGameServer: CSteamID; unIPServer: UInt32; usPortServer: UInt16); cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_RequestEncryptedAppTicket(APISteamUser: PISteamUser; pDataToInclude: Pointer; cbDataToInclude: Integer): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetEncryptedAppTicket(APISteamUser: PISteamUser; pTicket: Pointer; cbMaxTicket: Integer; pcbTicket: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetGameBadgeLevel(APISteamUser: PISteamUser; nSeries: Integer; bFoil: Boolean): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetPlayerSteamLevel(APISteamUser: PISteamUser): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_RequestStoreAuthURL(APISteamUser: PISteamUser; pchRedirectURL: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_BIsPhoneVerified(APISteamUser: PISteamUser): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_BIsTwoFactorEnabled(APISteamUser: PISteamUser): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_BIsPhoneIdentifying(APISteamUser: PISteamUser): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_BIsPhoneRequiringVerification(APISteamUser: PISteamUser): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetMarketEligibility(APISteamUser: PISteamUser): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_GetDurationControl(APISteamUser: PISteamUser): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUser_BSetDurationControlOnlineState(APISteamUser: PISteamUser; eNewState: EDurationControlOnlineState): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamFriends_GetPersonaName(APISteamFriends: PISteamFriends): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_SetPersonaName(APISteamFriends: PISteamFriends; pchPersonaName: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetPersonaState(APISteamFriends: PISteamFriends): EPersonaState; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendCount(APISteamFriends: PISteamFriends; iFriendFlags: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendByIndex(APISteamFriends: PISteamFriends; iFriend: Integer; iFriendFlags: Integer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendRelationship(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): EFriendRelationship; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendPersonaState(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): EPersonaState; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendPersonaName(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendGamePlayed(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID; pFriendGameInfo: PFriendGameInfo_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendPersonaNameHistory(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID; iPersonaName: Integer): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendSteamLevel(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetPlayerNickname(APISteamFriends: PISteamFriends; steamIDPlayer: CSteamID): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendsGroupCount(APISteamFriends: PISteamFriends): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendsGroupIDByIndex(APISteamFriends: PISteamFriends; iFG: Integer): FriendsGroupID_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendsGroupName(APISteamFriends: PISteamFriends; friendsGroupID: FriendsGroupID_t): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendsGroupMembersCount(APISteamFriends: PISteamFriends; friendsGroupID: FriendsGroupID_t): Integer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_GetFriendsGroupMembersList(APISteamFriends: PISteamFriends; friendsGroupID: FriendsGroupID_t; pOutSteamIDMembers: PCSteamID; nMembersCount: Integer); cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_HasFriend(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID; iFriendFlags: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanCount(APISteamFriends: PISteamFriends): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanByIndex(APISteamFriends: PISteamFriends; iClan: Integer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanName(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanTag(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanActivityCounts(APISteamFriends: PISteamFriends; steamIDClan: CSteamID; pnOnline: PInteger; pnInGame: PInteger; pnChatting: PInteger): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_DownloadClanActivityCounts(APISteamFriends: PISteamFriends; psteamIDClans: PCSteamID; cClansToRequest: Integer): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendCountFromSource(APISteamFriends: PISteamFriends; steamIDSource: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendFromSourceByIndex(APISteamFriends: PISteamFriends; steamIDSource: CSteamID; iFriend: Integer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_IsUserInSource(APISteamFriends: PISteamFriends; steamIDUser: CSteamID; steamIDSource: CSteamID): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_SetInGameVoiceSpeaking(APISteamFriends: PISteamFriends; steamIDUser: CSteamID; bSpeaking: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_ActivateGameOverlay(APISteamFriends: PISteamFriends; pchDialog: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_ActivateGameOverlayToUser(APISteamFriends: PISteamFriends; pchDialog: PAnsiChar; steamID: CSteamID); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage(APISteamFriends: PISteamFriends; pchURL: PAnsiChar; eMode: EActivateGameOverlayToWebPageMode); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_ActivateGameOverlayToStore(APISteamFriends: PISteamFriends; nAppID: AppId_t; eFlag: EOverlayToStoreFlag); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_SetPlayedWith(APISteamFriends: PISteamFriends; steamIDUserPlayedWith: CSteamID); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialog(APISteamFriends: PISteamFriends; steamIDLobby: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetSmallFriendAvatar(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetMediumFriendAvatar(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetLargeFriendAvatar(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_RequestUserInformation(APISteamFriends: PISteamFriends; steamIDUser: CSteamID; bRequireNameOnly: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_RequestClanOfficerList(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanOwner(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanOfficerCount(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanOfficerByIndex(APISteamFriends: PISteamFriends; steamIDClan: CSteamID; iOfficer: Integer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetUserRestrictions(APISteamFriends: PISteamFriends): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_SetRichPresence(APISteamFriends: PISteamFriends; pchKey: PAnsiChar; pchValue: PAnsiChar): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_ClearRichPresence(APISteamFriends: PISteamFriends); cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendRichPresence(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID; pchKey: PAnsiChar): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendRichPresenceKeyCount(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendRichPresenceKeyByIndex(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID; iKey: Integer): PAnsiChar; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_RequestFriendRichPresence(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_InviteUserToGame(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID; pchConnectString: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetCoplayFriendCount(APISteamFriends: PISteamFriends): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetCoplayFriend(APISteamFriends: PISteamFriends; iCoplayFriend: Integer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendCoplayTime(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendCoplayGame(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID): AppId_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_JoinClanChatRoom(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_LeaveClanChatRoom(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanChatMemberCount(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetChatMemberByIndex(APISteamFriends: PISteamFriends; steamIDClan: CSteamID; iUser: Integer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_SendClanChatMessage(APISteamFriends: PISteamFriends; steamIDClanChat: CSteamID; pchText: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetClanChatMessage(APISteamFriends: PISteamFriends; steamIDClanChat: CSteamID; iMessage: Integer; prgchText: Pointer; cchTextMax: Integer; peChatEntryType: PEChatEntryType; psteamidChatter: PCSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_IsClanChatAdmin(APISteamFriends: PISteamFriends; steamIDClanChat: CSteamID; steamIDUser: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_IsClanChatWindowOpenInSteam(APISteamFriends: PISteamFriends; steamIDClanChat: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_OpenClanChatWindowInSteam(APISteamFriends: PISteamFriends; steamIDClanChat: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_CloseClanChatWindowInSteam(APISteamFriends: PISteamFriends; steamIDClanChat: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_SetListenForFriendsMessages(APISteamFriends: PISteamFriends; bInterceptEnabled: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_ReplyToFriendMessage(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID; pchMsgToSend: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFriendMessage(APISteamFriends: PISteamFriends; steamIDFriend: CSteamID; iMessageID: Integer; pvData: Pointer; cubData: Integer; peChatEntryType: PEChatEntryType): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetFollowerCount(APISteamFriends: PISteamFriends; steamID: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_IsFollowing(APISteamFriends: PISteamFriends; steamID: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_EnumerateFollowingList(APISteamFriends: PISteamFriends; unStartIndex: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_IsClanPublic(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_IsClanOfficialGameGroup(APISteamFriends: PISteamFriends; steamIDClan: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_GetNumChatsWithUnreadPriorityMessages(APISteamFriends: PISteamFriends): Integer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_ActivateGameOverlayRemotePlayTogetherInviteDialog(APISteamFriends: PISteamFriends; steamIDLobby: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_ISteamFriends_RegisterProtocolInOverlayBrowser(APISteamFriends: PISteamFriends; pchProtocol: PAnsiChar): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialogConnectString(APISteamFriends: PISteamFriends; pchConnectString: PAnsiChar); cdecl; external STEAMLIB;

function SteamAPI_ISteamUtils_GetSecondsSinceAppActive(APISteamUtils: PISteamUtils): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetSecondsSinceComputerActive(APISteamUtils: PISteamUtils): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetConnectedUniverse(APISteamUtils: PISteamUtils): EUniverse; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetServerRealTime(APISteamUtils: PISteamUtils): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetIPCountry(APISteamUtils: PISteamUtils): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetImageSize(APISteamUtils: PISteamUtils; iImage: Integer; pnWidth: PUInt32; pnHeight: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetImageRGBA(APISteamUtils: PISteamUtils; iImage: Integer; pubDest: PUInt8; nDestBufferSize: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetCurrentBatteryPower(APISteamUtils: PISteamUtils): UInt8; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetAppID(APISteamUtils: PISteamUtils): UInt32; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUtils_SetOverlayNotificationPosition(APISteamUtils: PISteamUtils; eNotificationPosition: ENotificationPosition); cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_IsAPICallCompleted(APISteamUtils: PISteamUtils; hSteamAPICall: SteamAPICall_t; pbFailed: PBoolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetAPICallFailureReason(APISteamUtils: PISteamUtils; hSteamAPICall: SteamAPICall_t): ESteamAPICallFailure; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetAPICallResult(APISteamUtils: PISteamUtils; hSteamAPICall: SteamAPICall_t; pCallback: Pointer; cubCallback: Integer; iCallbackExpected: Integer; pbFailed: PBoolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetIPCCallCount(APISteamUtils: PISteamUtils): UInt32; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUtils_SetWarningMessageHook(APISteamUtils: PISteamUtils; pFunction: SteamAPIWarningMessageHook_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_IsOverlayEnabled(APISteamUtils: PISteamUtils): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_BOverlayNeedsPresent(APISteamUtils: PISteamUtils): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_CheckFileSignature(APISteamUtils: PISteamUtils; szFileName: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_ShowGamepadTextInput(APISteamUtils: PISteamUtils; eInputMode: EGamepadTextInputMode; eLineInputMode: EGamepadTextInputLineMode; pchDescription: PAnsiChar; unCharMax: UInt32; pchExistingText: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetEnteredGamepadTextLength(APISteamUtils: PISteamUtils): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetEnteredGamepadTextInput(APISteamUtils: PISteamUtils; pchText: PAnsiChar; cchText: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetSteamUILanguage(APISteamUtils: PISteamUtils): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_IsSteamRunningInVR(APISteamUtils: PISteamUtils): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUtils_SetOverlayNotificationInset(APISteamUtils: PISteamUtils; nHorizontalInset: Integer; nVerticalInset: Integer); cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_IsSteamInBigPictureMode(APISteamUtils: PISteamUtils): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUtils_StartVRDashboard(APISteamUtils: PISteamUtils); cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_IsVRHeadsetStreamingEnabled(APISteamUtils: PISteamUtils): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUtils_SetVRHeadsetStreamingEnabled(APISteamUtils: PISteamUtils; bEnabled: Boolean); cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_IsSteamChinaLauncher(APISteamUtils: PISteamUtils): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_InitFilterText(APISteamUtils: PISteamUtils; unFilterOptions: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_FilterText(APISteamUtils: PISteamUtils; eContext: ETextFilteringContext; sourceSteamID: CSteamID; pchInputMessage: PAnsiChar; pchOutFilteredText: PAnsiChar; nByteSizeOutFilteredText: UInt32): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_GetIPv6ConnectivityState(APISteamUtils: PISteamUtils; eProtocol: ESteamIPv6ConnectivityProtocol): ESteamIPv6ConnectivityState; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_IsSteamRunningOnSteamDeck(APISteamUtils: PISteamUtils): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_ShowFloatingGamepadTextInput(APISteamUtils: PISteamUtils; eKeyboardMode: EFloatingGamepadTextInputMode; nTextFieldXPosition: Integer; nTextFieldYPosition: Integer; nTextFieldWidth: Integer; nTextFieldHeight: Integer): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUtils_SetGameLauncherMode(APISteamUtils: PISteamUtils; bLauncherMode: Boolean); cdecl; external STEAMLIB;
function SteamAPI_ISteamUtils_DismissFloatingGamepadTextInput(APISteamUtils: PISteamUtils): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamMatchmaking_GetFavoriteGameCount(APISteamMatchmaking: PISteamMatchmaking): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetFavoriteGame(APISteamMatchmaking: PISteamMatchmaking; iGame: Integer; pnAppID: PAppId_t; pnIP: PUInt32; pnConnPort: PUInt16; pnQueryPort: PUInt16; punFlags: PUInt32; pRTime32LastPlayedOnServer: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_AddFavoriteGame(APISteamMatchmaking: PISteamMatchmaking; nAppID: AppId_t; nIP: UInt32; nConnPort: UInt16; nQueryPort: UInt16; unFlags: UInt32; rTime32LastPlayedOnServer: UInt32): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_RemoveFavoriteGame(APISteamMatchmaking: PISteamMatchmaking; nAppID: AppId_t; nIP: UInt32; nConnPort: UInt16; nQueryPort: UInt16; unFlags: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_RequestLobbyList(APISteamMatchmaking: PISteamMatchmaking): SteamAPICall_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_AddRequestLobbyListStringFilter(APISteamMatchmaking: PISteamMatchmaking; pchKeyToMatch: PAnsiChar; pchValueToMatch: PAnsiChar; eComparisonType: ELobbyComparison); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_AddRequestLobbyListNumericalFilter(APISteamMatchmaking: PISteamMatchmaking; pchKeyToMatch: PAnsiChar; nValueToMatch: Integer; eComparisonType: ELobbyComparison); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_AddRequestLobbyListNearValueFilter(APISteamMatchmaking: PISteamMatchmaking; pchKeyToMatch: PAnsiChar; nValueToBeCloseTo: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_AddRequestLobbyListFilterSlotsAvailable(APISteamMatchmaking: PISteamMatchmaking; nSlotsAvailable: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_AddRequestLobbyListDistanceFilter(APISteamMatchmaking: PISteamMatchmaking; eLobbyDistanceFilter: ELobbyDistanceFilter); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_AddRequestLobbyListResultCountFilter(APISteamMatchmaking: PISteamMatchmaking; cMaxResults: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_AddRequestLobbyListCompatibleMembersFilter(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyByIndex(APISteamMatchmaking: PISteamMatchmaking; iLobby: Integer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_CreateLobby(APISteamMatchmaking: PISteamMatchmaking; eLobbyType: ELobbyType; cMaxMembers: Integer): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_JoinLobby(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_LeaveLobby(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_InviteUserToLobby(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; steamIDInvitee: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetNumLobbyMembers(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyMemberByIndex(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; iMember: Integer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyData(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; pchKey: PAnsiChar): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_SetLobbyData(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; pchKey: PAnsiChar; pchValue: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyDataCount(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyDataByIndex(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; iLobbyData: Integer; pchKey: PAnsiChar; cchKeyBufferSize: Integer; pchValue: PAnsiChar; cchValueBufferSize: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_DeleteLobbyData(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; pchKey: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyMemberData(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; steamIDUser: CSteamID; pchKey: PAnsiChar): PAnsiChar; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_SetLobbyMemberData(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; pchKey: PAnsiChar; pchValue: PAnsiChar); cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_SendLobbyChatMsg(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; pvMsgBody: Pointer; cubMsgBody: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyChatEntry(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; iChatID: Integer; pSteamIDUser: PCSteamID; pvData: Pointer; cubData: Integer; peChatEntryType: PEChatEntryType): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_RequestLobbyData(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmaking_SetLobbyGameServer(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; unGameServerIP: UInt32; unGameServerPort: UInt16; steamIDGameServer: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyGameServer(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; punGameServerIP: PUInt32; punGameServerPort: PUInt16; psteamIDGameServer: PCSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_SetLobbyMemberLimit(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; cMaxMembers: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyMemberLimit(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_SetLobbyType(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; eLobbyType: ELobbyType): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_SetLobbyJoinable(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; bLobbyJoinable: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_GetLobbyOwner(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_SetLobbyOwner(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; steamIDNewOwner: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmaking_SetLinkedLobby(APISteamMatchmaking: PISteamMatchmaking; steamIDLobby: CSteamID; steamIDLobbyDependent: CSteamID): Boolean; cdecl; external STEAMLIB;

procedure SteamAPI_ISteamMatchmakingServerListResponse_ServerResponded(APISteamMatchmakingServerListResponse: PISteamMatchmakingServerListResponse; hRequest: HServerListRequest; iServer: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingServerListResponse_ServerFailedToRespond(APISteamMatchmakingServerListResponse: PISteamMatchmakingServerListResponse; hRequest: HServerListRequest; iServer: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingServerListResponse_RefreshComplete(APISteamMatchmakingServerListResponse: PISteamMatchmakingServerListResponse; hRequest: HServerListRequest; response: EMatchMakingServerResponse); cdecl; external STEAMLIB;

procedure SteamAPI_ISteamMatchmakingPingResponse_ServerResponded(APISteamMatchmakingPingResponse: PISteamMatchmakingPingResponse; server: Pgameserveritem_t); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingPingResponse_ServerFailedToRespond(APISteamMatchmakingPingResponse: PISteamMatchmakingPingResponse); cdecl; external STEAMLIB;

procedure SteamAPI_ISteamMatchmakingPlayersResponse_AddPlayerToList(APISteamMatchmakingPlayersResponse: PISteamMatchmakingPlayersResponse; pchName: PAnsiChar; nScore: Integer; flTimePlayed: Single); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingPlayersResponse_PlayersFailedToRespond(APISteamMatchmakingPlayersResponse: PISteamMatchmakingPlayersResponse); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingPlayersResponse_PlayersRefreshComplete(APISteamMatchmakingPlayersResponse: PISteamMatchmakingPlayersResponse); cdecl; external STEAMLIB;

procedure SteamAPI_ISteamMatchmakingRulesResponse_RulesResponded(APISteamMatchmakingRulesResponse: PISteamMatchmakingRulesResponse; pchRule: PAnsiChar; pchValue: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingRulesResponse_RulesFailedToRespond(APISteamMatchmakingRulesResponse: PISteamMatchmakingRulesResponse); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingRulesResponse_RulesRefreshComplete(APISteamMatchmakingRulesResponse: PISteamMatchmakingRulesResponse); cdecl; external STEAMLIB;

function SteamAPI_ISteamMatchmakingServers_RequestInternetServerList(APISteamMatchmakingServers: PISteamMatchmakingServers; iApp: AppId_t; ppchFilters: PPMatchMakingKeyValuePair_t; nFilters: UInt32; pRequestServersResponse: PISteamMatchmakingServerListResponse): HServerListRequest; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_RequestLANServerList(APISteamMatchmakingServers: PISteamMatchmakingServers; iApp: AppId_t; pRequestServersResponse: PISteamMatchmakingServerListResponse): HServerListRequest; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_RequestFriendsServerList(APISteamMatchmakingServers: PISteamMatchmakingServers; iApp: AppId_t; ppchFilters: PPMatchMakingKeyValuePair_t; nFilters: UInt32; pRequestServersResponse: PISteamMatchmakingServerListResponse): HServerListRequest; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_RequestFavoritesServerList(APISteamMatchmakingServers: PISteamMatchmakingServers; iApp: AppId_t; ppchFilters: PPMatchMakingKeyValuePair_t; nFilters: UInt32; pRequestServersResponse: PISteamMatchmakingServerListResponse): HServerListRequest; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_RequestHistoryServerList(APISteamMatchmakingServers: PISteamMatchmakingServers; iApp: AppId_t; ppchFilters: PPMatchMakingKeyValuePair_t; nFilters: UInt32; pRequestServersResponse: PISteamMatchmakingServerListResponse): HServerListRequest; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_RequestSpectatorServerList(APISteamMatchmakingServers: PISteamMatchmakingServers; iApp: AppId_t; ppchFilters: PPMatchMakingKeyValuePair_t; nFilters: UInt32; pRequestServersResponse: PISteamMatchmakingServerListResponse): HServerListRequest; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingServers_ReleaseRequest(APISteamMatchmakingServers: PISteamMatchmakingServers; hServerListRequest: HServerListRequest); cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_GetServerDetails(APISteamMatchmakingServers: PISteamMatchmakingServers; hRequest: HServerListRequest; iServer: Integer): Pgameserveritem_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingServers_CancelQuery(APISteamMatchmakingServers: PISteamMatchmakingServers; hRequest: HServerListRequest); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingServers_RefreshQuery(APISteamMatchmakingServers: PISteamMatchmakingServers; hRequest: HServerListRequest); cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_IsRefreshing(APISteamMatchmakingServers: PISteamMatchmakingServers; hRequest: HServerListRequest): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_GetServerCount(APISteamMatchmakingServers: PISteamMatchmakingServers; hRequest: HServerListRequest): Integer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingServers_RefreshServer(APISteamMatchmakingServers: PISteamMatchmakingServers; hRequest: HServerListRequest; iServer: Integer); cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_PingServer(APISteamMatchmakingServers: PISteamMatchmakingServers; unIP: UInt32; usPort: UInt16; pRequestServersResponse: PISteamMatchmakingPingResponse): HServerQuery; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_PlayerDetails(APISteamMatchmakingServers: PISteamMatchmakingServers; unIP: UInt32; usPort: UInt16; pRequestServersResponse: PISteamMatchmakingPlayersResponse): HServerQuery; cdecl; external STEAMLIB;
function SteamAPI_ISteamMatchmakingServers_ServerRules(APISteamMatchmakingServers: PISteamMatchmakingServers; unIP: UInt32; usPort: UInt16; pRequestServersResponse: PISteamMatchmakingRulesResponse): HServerQuery; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMatchmakingServers_CancelServerQuery(APISteamMatchmakingServers: PISteamMatchmakingServers; hServerQuery: HServerQuery); cdecl; external STEAMLIB;

function SteamAPI_ISteamGameSearch_AddGameSearchParams(APISteamGameSearch: PISteamGameSearch; pchKeyToFind: PAnsiChar; pchValuesToFind: PAnsiChar): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_SearchForGameWithLobby(APISteamGameSearch: PISteamGameSearch; steamIDLobby: CSteamID; nPlayerMin: Integer; nPlayerMax: Integer): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_SearchForGameSolo(APISteamGameSearch: PISteamGameSearch; nPlayerMin: Integer; nPlayerMax: Integer): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_AcceptGame(APISteamGameSearch: PISteamGameSearch): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_DeclineGame(APISteamGameSearch: PISteamGameSearch): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_RetrieveConnectionDetails(APISteamGameSearch: PISteamGameSearch; steamIDHost: CSteamID; pchConnectionDetails: PAnsiChar; cubConnectionDetails: Integer): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_EndGameSearch(APISteamGameSearch: PISteamGameSearch): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_SetGameHostParams(APISteamGameSearch: PISteamGameSearch; pchKey: PAnsiChar; pchValue: PAnsiChar): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_SetConnectionDetails(APISteamGameSearch: PISteamGameSearch; pchConnectionDetails: PAnsiChar; cubConnectionDetails: Integer): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_RequestPlayersForGame(APISteamGameSearch: PISteamGameSearch; nPlayerMin: Integer; nPlayerMax: Integer; nMaxTeamSize: Integer): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_HostConfirmGameStart(APISteamGameSearch: PISteamGameSearch; ullUniqueGameID: UInt64): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_CancelRequestPlayersForGame(APISteamGameSearch: PISteamGameSearch): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_SubmitPlayerResult(APISteamGameSearch: PISteamGameSearch; ullUniqueGameID: UInt64; steamIDPlayer: CSteamID; EPlayerResult: EPlayerResult_t): EGameSearchErrorCode_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameSearch_EndGame(APISteamGameSearch: PISteamGameSearch; ullUniqueGameID: UInt64): EGameSearchErrorCode_t; cdecl; external STEAMLIB;

function SteamAPI_ISteamParties_GetNumActiveBeacons(APISteamParties: PISteamParties): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_GetBeaconByIndex(APISteamParties: PISteamParties; unIndex: UInt32): PartyBeaconID_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_GetBeaconDetails(APISteamParties: PISteamParties; ulBeaconID: PartyBeaconID_t; pSteamIDBeaconOwner: PCSteamID; pLocation: PSteamPartyBeaconLocation_t; pchMetadata: PAnsiChar; cchMetadata: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_JoinParty(APISteamParties: PISteamParties; ulBeaconID: PartyBeaconID_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_GetNumAvailableBeaconLocations(APISteamParties: PISteamParties; puNumLocations: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_GetAvailableBeaconLocations(APISteamParties: PISteamParties; pLocationList: PSteamPartyBeaconLocation_t; uMaxNumLocations: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_CreateBeacon(APISteamParties: PISteamParties; unOpenSlots: UInt32; pBeaconLocation: PSteamPartyBeaconLocation_t; pchConnectString: PAnsiChar; pchMetadata: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamParties_OnReservationCompleted(APISteamParties: PISteamParties; ulBeacon: PartyBeaconID_t; steamIDUser: CSteamID); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamParties_CancelReservation(APISteamParties: PISteamParties; ulBeacon: PartyBeaconID_t; steamIDUser: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_ChangeNumOpenSlots(APISteamParties: PISteamParties; ulBeacon: PartyBeaconID_t; unOpenSlots: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_DestroyBeacon(APISteamParties: PISteamParties; ulBeacon: PartyBeaconID_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParties_GetBeaconLocationData(APISteamParties: PISteamParties; BeaconLocation: SteamPartyBeaconLocation_t; eData: ESteamPartyBeaconLocationData; pchDataStringOut: PAnsiChar; cchDataStringOut: Integer): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamRemoteStorage_FileWrite(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar; pvData: Pointer; cubData: Int32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileRead(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar; pvData: Pointer; cubDataToRead: Int32): Int32; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileWriteAsync(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar; pvData: Pointer; cubData: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileReadAsync(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar; nOffset: UInt32; cubToRead: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileReadAsyncComplete(APISteamRemoteStorage: PISteamRemoteStorage; hReadCall: SteamAPICall_t; pvBuffer: Pointer; cubToRead: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileForget(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileDelete(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileShare(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_SetSyncPlatforms(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar; eRemoteStoragePlatform: ERemoteStoragePlatform): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileWriteStreamOpen(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): UGCFileWriteStreamHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileWriteStreamWriteChunk(APISteamRemoteStorage: PISteamRemoteStorage; writeHandle: UGCFileWriteStreamHandle_t; pvData: Pointer; cubData: Int32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileWriteStreamClose(APISteamRemoteStorage: PISteamRemoteStorage; writeHandle: UGCFileWriteStreamHandle_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileWriteStreamCancel(APISteamRemoteStorage: PISteamRemoteStorage; writeHandle: UGCFileWriteStreamHandle_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FileExists(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_FilePersisted(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetFileSize(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): Int32; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetFileTimestamp(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): Int64; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetSyncPlatforms(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar): ERemoteStoragePlatform; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetFileCount(APISteamRemoteStorage: PISteamRemoteStorage): Int32; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetFileNameAndSize(APISteamRemoteStorage: PISteamRemoteStorage; iFile: Integer; pnFileSizeInBytes: PInt32): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetQuota(APISteamRemoteStorage: PISteamRemoteStorage; pnTotalBytes: PUInt64; puAvailableBytes: PUInt64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_IsCloudEnabledForAccount(APISteamRemoteStorage: PISteamRemoteStorage): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_IsCloudEnabledForApp(APISteamRemoteStorage: PISteamRemoteStorage): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamRemoteStorage_SetCloudEnabledForApp(APISteamRemoteStorage: PISteamRemoteStorage; bEnabled: Boolean); cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UGCDownload(APISteamRemoteStorage: PISteamRemoteStorage; hContent: UGCHandle_t; unPriority: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetUGCDownloadProgress(APISteamRemoteStorage: PISteamRemoteStorage; hContent: UGCHandle_t; pnBytesDownloaded: PInt32; pnBytesExpected: PInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetUGCDetails(APISteamRemoteStorage: PISteamRemoteStorage; hContent: UGCHandle_t; pnAppID: PAppId_t; ppchName: PPAnsiChar; pnFileSizeInBytes: PInt32; pSteamIDOwner: PCSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UGCRead(APISteamRemoteStorage: PISteamRemoteStorage; hContent: UGCHandle_t; pvData: Pointer; cubDataToRead: Int32; cOffset: UInt32; eAction: EUGCReadAction): Int32; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetCachedUGCCount(APISteamRemoteStorage: PISteamRemoteStorage): Int32; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetCachedUGCHandle(APISteamRemoteStorage: PISteamRemoteStorage; iCachedContent: Int32): UGCHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_PublishWorkshopFile(APISteamRemoteStorage: PISteamRemoteStorage; pchFile: PAnsiChar; pchPreviewFile: PAnsiChar; nConsumerAppId: AppId_t; pchTitle: PAnsiChar; pchDescription: PAnsiChar; eVisibility: ERemoteStoragePublishedFileVisibility; pTags: PSteamParamStringArray_t; eWorkshopFileType: EWorkshopFileType): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_CreatePublishedFileUpdateRequest(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t): PublishedFileUpdateHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UpdatePublishedFileFile(APISteamRemoteStorage: PISteamRemoteStorage; updateHandle: PublishedFileUpdateHandle_t; pchFile: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UpdatePublishedFilePreviewFile(APISteamRemoteStorage: PISteamRemoteStorage; updateHandle: PublishedFileUpdateHandle_t; pchPreviewFile: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTitle(APISteamRemoteStorage: PISteamRemoteStorage; updateHandle: PublishedFileUpdateHandle_t; pchTitle: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UpdatePublishedFileDescription(APISteamRemoteStorage: PISteamRemoteStorage; updateHandle: PublishedFileUpdateHandle_t; pchDescription: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UpdatePublishedFileVisibility(APISteamRemoteStorage: PISteamRemoteStorage; updateHandle: PublishedFileUpdateHandle_t; eVisibility: ERemoteStoragePublishedFileVisibility): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTags(APISteamRemoteStorage: PISteamRemoteStorage; updateHandle: PublishedFileUpdateHandle_t; pTags: PSteamParamStringArray_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_CommitPublishedFileUpdate(APISteamRemoteStorage: PISteamRemoteStorage; updateHandle: PublishedFileUpdateHandle_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetPublishedFileDetails(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t; unMaxSecondsOld: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_DeletePublishedFile(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_EnumerateUserPublishedFiles(APISteamRemoteStorage: PISteamRemoteStorage; unStartIndex: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_SubscribePublishedFile(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_EnumerateUserSubscribedFiles(APISteamRemoteStorage: PISteamRemoteStorage; unStartIndex: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UnsubscribePublishedFile(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription(APISteamRemoteStorage: PISteamRemoteStorage; updateHandle: PublishedFileUpdateHandle_t; pchChangeDescription: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetPublishedItemVoteDetails(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UpdateUserPublishedItemVote(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t; bVoteUp: Boolean): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetUserPublishedItemVoteDetails(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles(APISteamRemoteStorage: PISteamRemoteStorage; steamId: CSteamID; unStartIndex: UInt32; pRequiredTags: PSteamParamStringArray_t; pExcludedTags: PSteamParamStringArray_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_PublishVideo(APISteamRemoteStorage: PISteamRemoteStorage; eVideoProvider: EWorkshopVideoProvider; pchVideoAccount: PAnsiChar; pchVideoIdentifier: PAnsiChar; pchPreviewFile: PAnsiChar; nConsumerAppId: AppId_t; pchTitle: PAnsiChar; pchDescription: PAnsiChar; eVisibility: ERemoteStoragePublishedFileVisibility; pTags: PSteamParamStringArray_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_SetUserPublishedFileAction(APISteamRemoteStorage: PISteamRemoteStorage; unPublishedFileId: PublishedFileId_t; eAction: EWorkshopFileAction): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_EnumeratePublishedFilesByUserAction(APISteamRemoteStorage: PISteamRemoteStorage; eAction: EWorkshopFileAction; unStartIndex: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_EnumeratePublishedWorkshopFiles(APISteamRemoteStorage: PISteamRemoteStorage; eEnumerationType: EWorkshopEnumerationType; unStartIndex: UInt32; unCount: UInt32; unDays: UInt32; pTags: PSteamParamStringArray_t; pUserTags: PSteamParamStringArray_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation(APISteamRemoteStorage: PISteamRemoteStorage; hContent: UGCHandle_t; pchLocation: PAnsiChar; unPriority: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetLocalFileChangeCount(APISteamRemoteStorage: PISteamRemoteStorage): Int32; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_GetLocalFileChange(APISteamRemoteStorage: PISteamRemoteStorage; iFile: Integer; pEChangeType: PERemoteStorageLocalFileChange; pEFilePathType: PERemoteStorageFilePathType): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_BeginFileWriteBatch(APISteamRemoteStorage: PISteamRemoteStorage): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemoteStorage_EndFileWriteBatch(APISteamRemoteStorage: PISteamRemoteStorage): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamUserStats_RequestCurrentStats(APISteamUserStats: PISteamUserStats): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetStatInt32(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; pData: PInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetStatFloat(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; pData: PSingle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_SetStatInt32(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; nData: Int32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_SetStatFloat(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; fData: Single): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_UpdateAvgRateStat(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; flCountThisSession: Single; dSessionLength: Double): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetAchievement(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; pbAchieved: PBoolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_SetAchievement(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_ClearAchievement(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetAchievementAndUnlockTime(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; pbAchieved: PBoolean; punUnlockTime: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_StoreStats(APISteamUserStats: PISteamUserStats): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetAchievementIcon(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetAchievementDisplayAttribute(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; pchKey: PAnsiChar): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_IndicateAchievementProgress(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; nCurProgress: UInt32; nMaxProgress: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetNumAchievements(APISteamUserStats: PISteamUserStats): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetAchievementName(APISteamUserStats: PISteamUserStats; iAchievement: UInt32): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_RequestUserStats(APISteamUserStats: PISteamUserStats; steamIDUser: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetUserStatInt32(APISteamUserStats: PISteamUserStats; steamIDUser: CSteamID; pchName: PAnsiChar; pData: PInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetUserStatFloat(APISteamUserStats: PISteamUserStats; steamIDUser: CSteamID; pchName: PAnsiChar; pData: PSingle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetUserAchievement(APISteamUserStats: PISteamUserStats; steamIDUser: CSteamID; pchName: PAnsiChar; pbAchieved: PBoolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetUserAchievementAndUnlockTime(APISteamUserStats: PISteamUserStats; steamIDUser: CSteamID; pchName: PAnsiChar; pbAchieved: PBoolean; punUnlockTime: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_ResetAllStats(APISteamUserStats: PISteamUserStats; bAchievementsToo: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_FindOrCreateLeaderboard(APISteamUserStats: PISteamUserStats; pchLeaderboardName: PAnsiChar; eLeaderboardSortMethod: ELeaderboardSortMethod; eLeaderboardDisplayType: ELeaderboardDisplayType): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_FindLeaderboard(APISteamUserStats: PISteamUserStats; pchLeaderboardName: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetLeaderboardName(APISteamUserStats: PISteamUserStats; hSteamLeaderboard: SteamLeaderboard_t): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetLeaderboardEntryCount(APISteamUserStats: PISteamUserStats; hSteamLeaderboard: SteamLeaderboard_t): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetLeaderboardSortMethod(APISteamUserStats: PISteamUserStats; hSteamLeaderboard: SteamLeaderboard_t): ELeaderboardSortMethod; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetLeaderboardDisplayType(APISteamUserStats: PISteamUserStats; hSteamLeaderboard: SteamLeaderboard_t): ELeaderboardDisplayType; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_DownloadLeaderboardEntries(APISteamUserStats: PISteamUserStats; hSteamLeaderboard: SteamLeaderboard_t; eLeaderboardDataRequest: ELeaderboardDataRequest; nRangeStart: Integer; nRangeEnd: Integer): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_DownloadLeaderboardEntriesForUsers(APISteamUserStats: PISteamUserStats; hSteamLeaderboard: SteamLeaderboard_t; prgUsers: PCSteamID; cUsers: Integer): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetDownloadedLeaderboardEntry(APISteamUserStats: PISteamUserStats; hSteamLeaderboardEntries: SteamLeaderboardEntries_t; index: Integer; pLeaderboardEntry: PLeaderboardEntry_t; pDetails: PInt32; cDetailsMax: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_UploadLeaderboardScore(APISteamUserStats: PISteamUserStats; hSteamLeaderboard: SteamLeaderboard_t; eLeaderboardUploadScoreMethod: ELeaderboardUploadScoreMethod; nScore: Int32; pScoreDetails: PInt32; cScoreDetailsCount: Integer): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_AttachLeaderboardUGC(APISteamUserStats: PISteamUserStats; hSteamLeaderboard: SteamLeaderboard_t; hUGC: UGCHandle_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetNumberOfCurrentPlayers(APISteamUserStats: PISteamUserStats): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_RequestGlobalAchievementPercentages(APISteamUserStats: PISteamUserStats): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetMostAchievedAchievementInfo(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; unNameBufLen: UInt32; pflPercent: PSingle; pbAchieved: PBoolean): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetNextMostAchievedAchievementInfo(APISteamUserStats: PISteamUserStats; iIteratorPrevious: Integer; pchName: PAnsiChar; unNameBufLen: UInt32; pflPercent: PSingle; pbAchieved: PBoolean): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetAchievementAchievedPercent(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; pflPercent: PSingle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_RequestGlobalStats(APISteamUserStats: PISteamUserStats; nHistoryDays: Integer): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetGlobalStatInt64(APISteamUserStats: PISteamUserStats; pchStatName: PAnsiChar; pData: PInt64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetGlobalStatDouble(APISteamUserStats: PISteamUserStats; pchStatName: PAnsiChar; pData: PDouble): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetGlobalStatHistoryInt64(APISteamUserStats: PISteamUserStats; pchStatName: PAnsiChar; pData: PInt64; cubData: UInt32): Int32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetGlobalStatHistoryDouble(APISteamUserStats: PISteamUserStats; pchStatName: PAnsiChar; pData: PDouble; cubData: UInt32): Int32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetAchievementProgressLimitsInt32(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; pnMinProgress: PInt32; pnMaxProgress: PInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUserStats_GetAchievementProgressLimitsFloat(APISteamUserStats: PISteamUserStats; pchName: PAnsiChar; pfMinProgress: PSingle; pfMaxProgress: PSingle): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamApps_BIsSubscribed(APISteamApps: PISteamApps): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsLowViolence(APISteamApps: PISteamApps): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsCybercafe(APISteamApps: PISteamApps): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsVACBanned(APISteamApps: PISteamApps): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetCurrentGameLanguage(APISteamApps: PISteamApps): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetAvailableGameLanguages(APISteamApps: PISteamApps): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsSubscribedApp(APISteamApps: PISteamApps; appID: AppId_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsDlcInstalled(APISteamApps: PISteamApps; appID: AppId_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetEarliestPurchaseUnixTime(APISteamApps: PISteamApps; nAppID: AppId_t): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsSubscribedFromFreeWeekend(APISteamApps: PISteamApps): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetDLCCount(APISteamApps: PISteamApps): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BGetDLCDataByIndex(APISteamApps: PISteamApps; iDLC: Integer; pAppID: PAppId_t; pbAvailable: PBoolean; pchName: PAnsiChar; cchNameBufferSize: Integer): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamApps_InstallDLC(APISteamApps: PISteamApps; nAppID: AppId_t); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamApps_UninstallDLC(APISteamApps: PISteamApps; nAppID: AppId_t); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamApps_RequestAppProofOfPurchaseKey(APISteamApps: PISteamApps; nAppID: AppId_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetCurrentBetaName(APISteamApps: PISteamApps; pchName: PAnsiChar; cchNameBufferSize: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_MarkContentCorrupt(APISteamApps: PISteamApps; bMissingFilesOnly: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetInstalledDepots(APISteamApps: PISteamApps; appID: AppId_t; pvecDepots: PDepotId_t; cMaxDepots: UInt32): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetAppInstallDir(APISteamApps: PISteamApps; appID: AppId_t; pchFolder: PAnsiChar; cchFolderBufferSize: UInt32): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsAppInstalled(APISteamApps: PISteamApps; appID: AppId_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetAppOwner(APISteamApps: PISteamApps): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetLaunchQueryParam(APISteamApps: PISteamApps; pchKey: PAnsiChar): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetDlcDownloadProgress(APISteamApps: PISteamApps; nAppID: AppId_t; punBytesDownloaded: PUInt64; punBytesTotal: PUInt64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetAppBuildId(APISteamApps: PISteamApps): Integer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamApps_RequestAllProofOfPurchaseKeys(APISteamApps: PISteamApps); cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetFileDetails(APISteamApps: PISteamApps; pszFileName: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_GetLaunchCommandLine(APISteamApps: PISteamApps; pszCommandLine: PAnsiChar; cubCommandLine: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsSubscribedFromFamilySharing(APISteamApps: PISteamApps): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamApps_BIsTimedTrial(APISteamApps: PISteamApps; punSecondsAllowed: PUInt32; punSecondsPlayed: PUInt32): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamNetworking_SendP2PPacket(APISteamNetworking: PISteamNetworking; steamIDRemote: CSteamID; pubData: Pointer; cubData: UInt32; eP2PSendType: EP2PSend; nChannel: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_IsP2PPacketAvailable(APISteamNetworking: PISteamNetworking; pcubMsgSize: PUInt32; nChannel: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_ReadP2PPacket(APISteamNetworking: PISteamNetworking; pubDest: Pointer; cubDest: UInt32; pcubMsgSize: PUInt32; psteamIDRemote: PCSteamID; nChannel: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_AcceptP2PSessionWithUser(APISteamNetworking: PISteamNetworking; steamIDRemote: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_CloseP2PSessionWithUser(APISteamNetworking: PISteamNetworking; steamIDRemote: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_CloseP2PChannelWithUser(APISteamNetworking: PISteamNetworking; steamIDRemote: CSteamID; nChannel: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_GetP2PSessionState(APISteamNetworking: PISteamNetworking; steamIDRemote: CSteamID; pConnectionState: PP2PSessionState_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_AllowP2PPacketRelay(APISteamNetworking: PISteamNetworking; bAllow: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_CreateListenSocket(APISteamNetworking: PISteamNetworking; nVirtualP2PPort: Integer; nIP: SteamIPAddress_t; nPort: UInt16; bAllowUseOfPacketRelay: Boolean): SNetListenSocket_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_CreateP2PConnectionSocket(APISteamNetworking: PISteamNetworking; steamIDTarget: CSteamID; nVirtualPort: Integer; nTimeoutSec: Integer; bAllowUseOfPacketRelay: Boolean): SNetSocket_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_CreateConnectionSocket(APISteamNetworking: PISteamNetworking; nIP: SteamIPAddress_t; nPort: UInt16; nTimeoutSec: Integer): SNetSocket_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_DestroySocket(APISteamNetworking: PISteamNetworking; hSocket: SNetSocket_t; bNotifyRemoteEnd: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_DestroyListenSocket(APISteamNetworking: PISteamNetworking; hSocket: SNetListenSocket_t; bNotifyRemoteEnd: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_SendDataOnSocket(APISteamNetworking: PISteamNetworking; hSocket: SNetSocket_t; pubData: Pointer; cubData: UInt32; bReliable: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_IsDataAvailableOnSocket(APISteamNetworking: PISteamNetworking; hSocket: SNetSocket_t; pcubMsgSize: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_RetrieveDataFromSocket(APISteamNetworking: PISteamNetworking; hSocket: SNetSocket_t; pubDest: Pointer; cubDest: UInt32; pcubMsgSize: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_IsDataAvailable(APISteamNetworking: PISteamNetworking; hListenSocket: SNetListenSocket_t; pcubMsgSize: PUInt32; phSocket: PSNetSocket_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_RetrieveData(APISteamNetworking: PISteamNetworking; hListenSocket: SNetListenSocket_t; pubDest: Pointer; cubDest: UInt32; pcubMsgSize: PUInt32; phSocket: PSNetSocket_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_GetSocketInfo(APISteamNetworking: PISteamNetworking; hSocket: SNetSocket_t; pSteamIDRemote: PCSteamID; peSocketStatus: PInteger; punIPRemote: PSteamIPAddress_t; punPortRemote: PUInt16): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_GetListenSocketInfo(APISteamNetworking: PISteamNetworking; hListenSocket: SNetListenSocket_t; pnIP: PSteamIPAddress_t; pnPort: PUInt16): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_GetSocketConnectionType(APISteamNetworking: PISteamNetworking; hSocket: SNetSocket_t): ESNetSocketConnectionType; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworking_GetMaxPacketSize(APISteamNetworking: PISteamNetworking; hSocket: SNetSocket_t): Integer; cdecl; external STEAMLIB;

function SteamAPI_ISteamScreenshots_WriteScreenshot(APISteamScreenshots: PISteamScreenshots; pubRGB: Pointer; cubRGB: UInt32; nWidth: Integer; nHeight: Integer): ScreenshotHandle; cdecl; external STEAMLIB;
function SteamAPI_ISteamScreenshots_AddScreenshotToLibrary(APISteamScreenshots: PISteamScreenshots; pchFilename: PAnsiChar; pchThumbnailFilename: PAnsiChar; nWidth: Integer; nHeight: Integer): ScreenshotHandle; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamScreenshots_TriggerScreenshot(APISteamScreenshots: PISteamScreenshots); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamScreenshots_HookScreenshots(APISteamScreenshots: PISteamScreenshots; bHook: Boolean); cdecl; external STEAMLIB;
function SteamAPI_ISteamScreenshots_SetLocation(APISteamScreenshots: PISteamScreenshots; hScreenshot: ScreenshotHandle; pchLocation: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamScreenshots_TagUser(APISteamScreenshots: PISteamScreenshots; hScreenshot: ScreenshotHandle; steamID: CSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamScreenshots_TagPublishedFile(APISteamScreenshots: PISteamScreenshots; hScreenshot: ScreenshotHandle; unPublishedFileID: PublishedFileId_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamScreenshots_IsScreenshotsHooked(APISteamScreenshots: PISteamScreenshots): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamScreenshots_AddVRScreenshotToLibrary(APISteamScreenshots: PISteamScreenshots; eType: EVRScreenshotType; pchFilename: PAnsiChar; pchVRFilename: PAnsiChar): ScreenshotHandle; cdecl; external STEAMLIB;

function SteamAPI_ISteamMusic_BIsEnabled(APISteamMusic: PISteamMusic): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusic_BIsPlaying(APISteamMusic: PISteamMusic): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusic_GetPlaybackStatus(APISteamMusic: PISteamMusic): AudioPlayback_Status; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMusic_Play(APISteamMusic: PISteamMusic); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMusic_Pause(APISteamMusic: PISteamMusic); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMusic_PlayPrevious(APISteamMusic: PISteamMusic); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMusic_PlayNext(APISteamMusic: PISteamMusic); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamMusic_SetVolume(APISteamMusic: PISteamMusic; flVolume: Single); cdecl; external STEAMLIB;
function SteamAPI_ISteamMusic_GetVolume(APISteamMusic: PISteamMusic): Single; cdecl; external STEAMLIB;

function SteamAPI_ISteamMusicRemote_RegisterSteamMusicRemote(APISteamMusicRemote: PISteamMusicRemote; pchName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_DeregisterSteamMusicRemote(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_BIsCurrentMusicRemote(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_BActivationSuccess(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_SetDisplayName(APISteamMusicRemote: PISteamMusicRemote; pchDisplayName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_SetPNGIcon_64x64(APISteamMusicRemote: PISteamMusicRemote; pvBuffer: Pointer; cbBufferLength: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_EnablePlayPrevious(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_EnablePlayNext(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_EnableShuffled(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_EnableLooped(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_EnableQueue(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_EnablePlaylists(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_UpdatePlaybackStatus(APISteamMusicRemote: PISteamMusicRemote; nStatus: AudioPlayback_Status): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_UpdateShuffled(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_UpdateLooped(APISteamMusicRemote: PISteamMusicRemote; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_UpdateVolume(APISteamMusicRemote: PISteamMusicRemote; flValue: Single): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_CurrentEntryWillChange(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_CurrentEntryIsAvailable(APISteamMusicRemote: PISteamMusicRemote; bAvailable: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_UpdateCurrentEntryText(APISteamMusicRemote: PISteamMusicRemote; pchText: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_UpdateCurrentEntryElapsedSeconds(APISteamMusicRemote: PISteamMusicRemote; nValue: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_UpdateCurrentEntryCoverArt(APISteamMusicRemote: PISteamMusicRemote; pvBuffer: Pointer; cbBufferLength: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_CurrentEntryDidChange(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_QueueWillChange(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_ResetQueueEntries(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_SetQueueEntry(APISteamMusicRemote: PISteamMusicRemote; nID: Integer; nPosition: Integer; pchEntryText: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_SetCurrentQueueEntry(APISteamMusicRemote: PISteamMusicRemote; nID: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_QueueDidChange(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_PlaylistWillChange(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_ResetPlaylistEntries(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_SetPlaylistEntry(APISteamMusicRemote: PISteamMusicRemote; nID: Integer; nPosition: Integer; pchEntryText: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_SetCurrentPlaylistEntry(APISteamMusicRemote: PISteamMusicRemote; nID: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamMusicRemote_PlaylistDidChange(APISteamMusicRemote: PISteamMusicRemote): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamHTTP_CreateHTTPRequest(APISteamHTTP: PISteamHTTP; eHTTPRequestMethod: EHTTPMethod; pchAbsoluteURL: PAnsiChar): HTTPRequestHandle; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestContextValue(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; ulContextValue: UInt64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestNetworkActivityTimeout(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; unTimeoutSeconds: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestHeaderValue(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pchHeaderName: PAnsiChar; pchHeaderValue: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestGetOrPostParameter(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pchParamName: PAnsiChar; pchParamValue: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SendHTTPRequest(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pCallHandle: PSteamAPICall_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SendHTTPRequestAndStreamResponse(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pCallHandle: PSteamAPICall_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_DeferHTTPRequest(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_PrioritizeHTTPRequest(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_GetHTTPResponseHeaderSize(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pchHeaderName: PAnsiChar; unResponseHeaderSize: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_GetHTTPResponseHeaderValue(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pchHeaderName: PAnsiChar; pHeaderValueBuffer: PUInt8; unBufferSize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_GetHTTPResponseBodySize(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; unBodySize: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_GetHTTPResponseBodyData(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pBodyDataBuffer: PUInt8; unBufferSize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_GetHTTPStreamingResponseBodyData(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; cOffset: UInt32; pBodyDataBuffer: PUInt8; unBufferSize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_ReleaseHTTPRequest(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_GetHTTPDownloadProgressPct(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pflPercentOut: PSingle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestRawPostBody(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pchContentType: PAnsiChar; pubBody: PUInt8; unBodyLen: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_CreateCookieContainer(APISteamHTTP: PISteamHTTP; bAllowResponsesToModify: Boolean): HTTPCookieContainerHandle; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_ReleaseCookieContainer(APISteamHTTP: PISteamHTTP; hCookieContainer: HTTPCookieContainerHandle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetCookie(APISteamHTTP: PISteamHTTP; hCookieContainer: HTTPCookieContainerHandle; pchHost: PAnsiChar; pchUrl: PAnsiChar; pchCookie: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestCookieContainer(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; hCookieContainer: HTTPCookieContainerHandle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestUserAgentInfo(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pchUserAgentInfo: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestRequiresVerifiedCertificate(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; bRequireVerifiedCertificate: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_SetHTTPRequestAbsoluteTimeoutMS(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; unMilliseconds: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTTP_GetHTTPRequestWasTimedOut(APISteamHTTP: PISteamHTTP; hRequest: HTTPRequestHandle; pbWasTimedOut: PBoolean): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamInput_Init(APISteamInput: PISteamInput; bExplicitlyCallRunFrame: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_Shutdown(APISteamInput: PISteamInput): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_SetInputActionManifestFilePath(APISteamInput: PISteamInput; pchInputActionManifestAbsolutePath: PAnsiChar): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_RunFrame(APISteamInput: PISteamInput; bReservedValue: Boolean); cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_BWaitForData(APISteamInput: PISteamInput; bWaitForever: Boolean; unTimeout: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_BNewDataAvailable(APISteamInput: PISteamInput): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetConnectedControllers(APISteamInput: PISteamInput; handlesOut: PInputHandle_t): Integer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_EnableDeviceCallbacks(APISteamInput: PISteamInput); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_EnableActionEventCallbacks(APISteamInput: PISteamInput; pCallback: SteamInputActionEventCallbackPointer); cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetActionSetHandle(APISteamInput: PISteamInput; pszActionSetName: PAnsiChar): InputActionSetHandle_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_ActivateActionSet(APISteamInput: PISteamInput; inputHandle: InputHandle_t; actionSetHandle: InputActionSetHandle_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetCurrentActionSet(APISteamInput: PISteamInput; inputHandle: InputHandle_t): InputActionSetHandle_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_ActivateActionSetLayer(APISteamInput: PISteamInput; inputHandle: InputHandle_t; actionSetLayerHandle: InputActionSetHandle_t); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_DeactivateActionSetLayer(APISteamInput: PISteamInput; inputHandle: InputHandle_t; actionSetLayerHandle: InputActionSetHandle_t); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_DeactivateAllActionSetLayers(APISteamInput: PISteamInput; inputHandle: InputHandle_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetActiveActionSetLayers(APISteamInput: PISteamInput; inputHandle: InputHandle_t; handlesOut: PInputActionSetHandle_t): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetDigitalActionHandle(APISteamInput: PISteamInput; pszActionName: PAnsiChar): InputDigitalActionHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetDigitalActionData(APISteamInput: PISteamInput; inputHandle: InputHandle_t; digitalActionHandle: InputDigitalActionHandle_t): InputDigitalActionData_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetDigitalActionOrigins(APISteamInput: PISteamInput; inputHandle: InputHandle_t; actionSetHandle: InputActionSetHandle_t; digitalActionHandle: InputDigitalActionHandle_t; originsOut: PEInputActionOrigin): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetStringForDigitalActionName(APISteamInput: PISteamInput; eActionHandle: InputDigitalActionHandle_t): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetAnalogActionHandle(APISteamInput: PISteamInput; pszActionName: PAnsiChar): InputAnalogActionHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetAnalogActionData(APISteamInput: PISteamInput; inputHandle: InputHandle_t; analogActionHandle: InputAnalogActionHandle_t): InputAnalogActionData_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetAnalogActionOrigins(APISteamInput: PISteamInput; inputHandle: InputHandle_t; actionSetHandle: InputActionSetHandle_t; analogActionHandle: InputAnalogActionHandle_t; originsOut: PEInputActionOrigin): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetGlyphPNGForActionOrigin(APISteamInput: PISteamInput; eOrigin: EInputActionOrigin; eSize: ESteamInputGlyphSize; unFlags: UInt32): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetGlyphSVGForActionOrigin(APISteamInput: PISteamInput; eOrigin: EInputActionOrigin; unFlags: UInt32): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetGlyphForActionOrigin_Legacy(APISteamInput: PISteamInput; eOrigin: EInputActionOrigin): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetStringForActionOrigin(APISteamInput: PISteamInput; eOrigin: EInputActionOrigin): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetStringForAnalogActionName(APISteamInput: PISteamInput; eActionHandle: InputAnalogActionHandle_t): PAnsiChar; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_StopAnalogActionMomentum(APISteamInput: PISteamInput; inputHandle: InputHandle_t; eAction: InputAnalogActionHandle_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetMotionData(APISteamInput: PISteamInput; inputHandle: InputHandle_t): InputMotionData_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_TriggerVibration(APISteamInput: PISteamInput; inputHandle: InputHandle_t; usLeftSpeed: UInt16; usRightSpeed: UInt16); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_TriggerVibrationExtended(APISteamInput: PISteamInput; inputHandle: InputHandle_t; usLeftSpeed: UInt16; usRightSpeed: UInt16; usLeftTriggerSpeed: UInt16; usRightTriggerSpeed: UInt16); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_TriggerSimpleHapticEvent(APISteamInput: PISteamInput; inputHandle: InputHandle_t; eHapticLocation: EControllerHapticLocation; nIntensity: UInt8; nGainDB: AnsiChar; nOtherIntensity: UInt8; nOtherGainDB: AnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_SetLEDColor(APISteamInput: PISteamInput; inputHandle: InputHandle_t; nColorR: UInt8; nColorG: UInt8; nColorB: UInt8; nFlags: UInt32); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_Legacy_TriggerHapticPulse(APISteamInput: PISteamInput; inputHandle: InputHandle_t; eTargetPad: ESteamControllerPad; usDurationMicroSec: UInt16); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInput_Legacy_TriggerRepeatedHapticPulse(APISteamInput: PISteamInput; inputHandle: InputHandle_t; eTargetPad: ESteamControllerPad; usDurationMicroSec: UInt16; usOffMicroSec: UInt16; unRepeat: UInt16; nFlags: UInt32); cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_ShowBindingPanel(APISteamInput: PISteamInput; inputHandle: InputHandle_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetInputTypeForHandle(APISteamInput: PISteamInput; inputHandle: InputHandle_t): ESteamInputType; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetControllerForGamepadIndex(APISteamInput: PISteamInput; nIndex: Integer): InputHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetGamepadIndexForController(APISteamInput: PISteamInput; ulinputHandle: InputHandle_t): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetStringForXboxOrigin(APISteamInput: PISteamInput; eOrigin: EXboxOrigin): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetGlyphForXboxOrigin(APISteamInput: PISteamInput; eOrigin: EXboxOrigin): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetActionOriginFromXboxOrigin(APISteamInput: PISteamInput; inputHandle: InputHandle_t; eOrigin: EXboxOrigin): EInputActionOrigin; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_TranslateActionOrigin(APISteamInput: PISteamInput; eDestinationInputType: ESteamInputType; eSourceOrigin: EInputActionOrigin): EInputActionOrigin; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetDeviceBindingRevision(APISteamInput: PISteamInput; inputHandle: InputHandle_t; pMajor: PInteger; pMinor: PInteger): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetRemotePlaySessionID(APISteamInput: PISteamInput; inputHandle: InputHandle_t): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamInput_GetSessionInputConfigurationSettings(APISteamInput: PISteamInput): UInt16; cdecl; external STEAMLIB;

function SteamAPI_ISteamController_Init(APISteamController: PISteamController): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_Shutdown(APISteamController: PISteamController): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_RunFrame(APISteamController: PISteamController); cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetConnectedControllers(APISteamController: PISteamController; handlesOut: PControllerHandle_t): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetActionSetHandle(APISteamController: PISteamController; pszActionSetName: PAnsiChar): ControllerActionSetHandle_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_ActivateActionSet(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; actionSetHandle: ControllerActionSetHandle_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetCurrentActionSet(APISteamController: PISteamController; controllerHandle: ControllerHandle_t): ControllerActionSetHandle_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_ActivateActionSetLayer(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; actionSetLayerHandle: ControllerActionSetHandle_t); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_DeactivateActionSetLayer(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; actionSetLayerHandle: ControllerActionSetHandle_t); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_DeactivateAllActionSetLayers(APISteamController: PISteamController; controllerHandle: ControllerHandle_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetActiveActionSetLayers(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; handlesOut: PControllerActionSetHandle_t): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetDigitalActionHandle(APISteamController: PISteamController; pszActionName: PAnsiChar): ControllerDigitalActionHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetDigitalActionData(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; digitalActionHandle: ControllerDigitalActionHandle_t): InputDigitalActionData_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetDigitalActionOrigins(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; actionSetHandle: ControllerActionSetHandle_t; digitalActionHandle: ControllerDigitalActionHandle_t; originsOut: PEControllerActionOrigin): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetAnalogActionHandle(APISteamController: PISteamController; pszActionName: PAnsiChar): ControllerAnalogActionHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetAnalogActionData(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; analogActionHandle: ControllerAnalogActionHandle_t): InputAnalogActionData_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetAnalogActionOrigins(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; actionSetHandle: ControllerActionSetHandle_t; analogActionHandle: ControllerAnalogActionHandle_t; originsOut: PEControllerActionOrigin): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetGlyphForActionOrigin(APISteamController: PISteamController; eOrigin: EControllerActionOrigin): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetStringForActionOrigin(APISteamController: PISteamController; eOrigin: EControllerActionOrigin): PAnsiChar; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_StopAnalogActionMomentum(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; eAction: ControllerAnalogActionHandle_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetMotionData(APISteamController: PISteamController; controllerHandle: ControllerHandle_t): InputMotionData_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_TriggerHapticPulse(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; eTargetPad: ESteamControllerPad; usDurationMicroSec: UInt16); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_TriggerRepeatedHapticPulse(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; eTargetPad: ESteamControllerPad; usDurationMicroSec: UInt16; usOffMicroSec: UInt16; unRepeat: UInt16; nFlags: UInt32); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_TriggerVibration(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; usLeftSpeed: UInt16; usRightSpeed: UInt16); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamController_SetLEDColor(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; nColorR: UInt8; nColorG: UInt8; nColorB: UInt8; nFlags: UInt32); cdecl; external STEAMLIB;
function SteamAPI_ISteamController_ShowBindingPanel(APISteamController: PISteamController; controllerHandle: ControllerHandle_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetInputTypeForHandle(APISteamController: PISteamController; controllerHandle: ControllerHandle_t): ESteamInputType; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetControllerForGamepadIndex(APISteamController: PISteamController; nIndex: Integer): ControllerHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetGamepadIndexForController(APISteamController: PISteamController; ulControllerHandle: ControllerHandle_t): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetStringForXboxOrigin(APISteamController: PISteamController; eOrigin: EXboxOrigin): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetGlyphForXboxOrigin(APISteamController: PISteamController; eOrigin: EXboxOrigin): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetActionOriginFromXboxOrigin(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; eOrigin: EXboxOrigin): EControllerActionOrigin; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_TranslateActionOrigin(APISteamController: PISteamController; eDestinationInputType: ESteamInputType; eSourceOrigin: EControllerActionOrigin): EControllerActionOrigin; cdecl; external STEAMLIB;
function SteamAPI_ISteamController_GetControllerBindingRevision(APISteamController: PISteamController; controllerHandle: ControllerHandle_t; pMajor: PInteger; pMinor: PInteger): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamUGC_CreateQueryUserUGCRequest(APISteamUGC: PISteamUGC; unAccountID: AccountID_t; eListType: EUserUGCList; eMatchingUGCType: EUGCMatchingUGCType; eSortOrder: EUserUGCListSortOrder; nCreatorAppID: AppId_t; nConsumerAppID: AppId_t; unPage: UInt32): UGCQueryHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_CreateQueryAllUGCRequestPage(APISteamUGC: PISteamUGC; eQueryType: EUGCQuery; eMatchingeMatchingUGCTypeFileType: EUGCMatchingUGCType; nCreatorAppID: AppId_t; nConsumerAppID: AppId_t; unPage: UInt32): UGCQueryHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_CreateQueryAllUGCRequestCursor(APISteamUGC: PISteamUGC; eQueryType: EUGCQuery; eMatchingeMatchingUGCTypeFileType: EUGCMatchingUGCType; nCreatorAppID: AppId_t; nConsumerAppID: AppId_t; pchCursor: PAnsiChar): UGCQueryHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_CreateQueryUGCDetailsRequest(APISteamUGC: PISteamUGC; pvecPublishedFileID: PPublishedFileId_t; unNumPublishedFileIDs: UInt32): UGCQueryHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SendQueryUGCRequest(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCResult(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; pDetails: PSteamUGCDetails_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCNumTags(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCTag(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; indexTag: UInt32; pchValue: PAnsiChar; cchValueSize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCTagDisplayName(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; indexTag: UInt32; pchValue: PAnsiChar; cchValueSize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCPreviewURL(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; pchURL: PAnsiChar; cchURLSize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCMetadata(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; pchMetadata: PAnsiChar; cchMetadatasize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCChildren(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; pvecPublishedFileID: PPublishedFileId_t; cMaxEntries: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCStatistic(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; eStatType: EItemStatistic; pStatValue: PUInt64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCNumAdditionalPreviews(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCAdditionalPreview(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; previewIndex: UInt32; pchURLOrVideoID: PAnsiChar; cchURLSize: UInt32; pchOriginalFileName: PAnsiChar; cchOriginalFileNameSize: UInt32; pPreviewType: PEItemPreviewType): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCNumKeyValueTags(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryUGCKeyValueTag(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; keyValueTagIndex: UInt32; pchKey: PAnsiChar; cchKeySize: UInt32; pchValue: PAnsiChar; cchValueSize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetQueryFirstUGCKeyValueTag(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; index: UInt32; pchKey: PAnsiChar; pchValue: PAnsiChar; cchValueSize: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_ReleaseQueryUGCRequest(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddRequiredTag(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; pTagName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddRequiredTagGroup(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; pTagGroups: PSteamParamStringArray_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddExcludedTag(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; pTagName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetReturnOnlyIDs(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; bReturnOnlyIDs: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetReturnKeyValueTags(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; bReturnKeyValueTags: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetReturnLongDescription(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; bReturnLongDescription: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetReturnMetadata(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; bReturnMetadata: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetReturnChildren(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; bReturnChildren: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetReturnAdditionalPreviews(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; bReturnAdditionalPreviews: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetReturnTotalOnly(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; bReturnTotalOnly: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetReturnPlaytimeStats(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; unDays: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetLanguage(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; pchLanguage: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetAllowCachedResponse(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; unMaxAgeSeconds: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetCloudFileNameFilter(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; pMatchCloudFileName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetMatchAnyTag(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; bMatchAnyTag: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetSearchText(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; pSearchText: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetRankedByTrendDays(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; unDays: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetTimeCreatedDateRange(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; rtStart: RTime32; rtEnd: RTime32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetTimeUpdatedDateRange(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; rtStart: RTime32; rtEnd: RTime32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddRequiredKeyValueTag(APISteamUGC: PISteamUGC; handle: UGCQueryHandle_t; pKey: PAnsiChar; pValue: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_RequestUGCDetails(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t; unMaxAgeSeconds: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_CreateItem(APISteamUGC: PISteamUGC; nConsumerAppId: AppId_t; eFileType: EWorkshopFileType): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_StartItemUpdate(APISteamUGC: PISteamUGC; nConsumerAppId: AppId_t; nPublishedFileID: PublishedFileId_t): UGCUpdateHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetItemTitle(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pchTitle: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetItemDescription(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pchDescription: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetItemUpdateLanguage(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pchLanguage: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetItemMetadata(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pchMetaData: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetItemVisibility(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; eVisibility: ERemoteStoragePublishedFileVisibility): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetItemTags(APISteamUGC: PISteamUGC; updateHandle: UGCUpdateHandle_t; pTags: PSteamParamStringArray_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetItemContent(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pszContentFolder: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetItemPreview(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pszPreviewFile: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetAllowLegacyUpload(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; bAllowLegacyUpload: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_RemoveAllItemKeyValueTags(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_RemoveItemKeyValueTags(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pchKey: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddItemKeyValueTag(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pchKey: PAnsiChar; pchValue: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddItemPreviewFile(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pszPreviewFile: PAnsiChar; aType: EItemPreviewType): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddItemPreviewVideo(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pszVideoID: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_UpdateItemPreviewFile(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; index: UInt32; pszPreviewFile: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_UpdateItemPreviewVideo(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; index: UInt32; pszVideoID: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_RemoveItemPreview(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; index: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SubmitItemUpdate(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; pchChangeNote: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetItemUpdateProgress(APISteamUGC: PISteamUGC; handle: UGCUpdateHandle_t; punBytesProcessed: PUInt64; punBytesTotal: PUInt64): EItemUpdateStatus; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SetUserItemVote(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t; bVoteUp: Boolean): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetUserItemVote(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddItemToFavorites(APISteamUGC: PISteamUGC; nAppId: AppId_t; nPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_RemoveItemFromFavorites(APISteamUGC: PISteamUGC; nAppId: AppId_t; nPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_SubscribeItem(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_UnsubscribeItem(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetNumSubscribedItems(APISteamUGC: PISteamUGC): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetSubscribedItems(APISteamUGC: PISteamUGC; pvecPublishedFileID: PPublishedFileId_t; cMaxEntries: UInt32): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetItemState(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetItemInstallInfo(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t; punSizeOnDisk: PUInt64; pchFolder: PAnsiChar; cchFolderSize: UInt32; punTimeStamp: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetItemDownloadInfo(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t; punBytesDownloaded: PUInt64; punBytesTotal: PUInt64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_DownloadItem(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t; bHighPriority: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_BInitWorkshopForGameServer(APISteamUGC: PISteamUGC; unWorkshopDepotID: DepotId_t; pszFolder: PAnsiChar): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamUGC_SuspendDownloads(APISteamUGC: PISteamUGC; bSuspend: Boolean); cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_StartPlaytimeTracking(APISteamUGC: PISteamUGC; pvecPublishedFileID: PPublishedFileId_t; unNumPublishedFileIDs: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_StopPlaytimeTracking(APISteamUGC: PISteamUGC; pvecPublishedFileID: PPublishedFileId_t; unNumPublishedFileIDs: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_StopPlaytimeTrackingForAllItems(APISteamUGC: PISteamUGC): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddDependency(APISteamUGC: PISteamUGC; nParentPublishedFileID: PublishedFileId_t; nChildPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_RemoveDependency(APISteamUGC: PISteamUGC; nParentPublishedFileID: PublishedFileId_t; nChildPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_AddAppDependency(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t; nAppID: AppId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_RemoveAppDependency(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t; nAppID: AppId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetAppDependencies(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_DeleteItem(APISteamUGC: PISteamUGC; nPublishedFileID: PublishedFileId_t): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_ShowWorkshopEULA(APISteamUGC: PISteamUGC): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamUGC_GetWorkshopEULAStatus(APISteamUGC: PISteamUGC): SteamAPICall_t; cdecl; external STEAMLIB;

function SteamAPI_ISteamAppList_GetNumInstalledApps(APISteamAppList: PISteamAppList): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamAppList_GetInstalledApps(APISteamAppList: PISteamAppList; pvecAppID: PAppId_t; unMaxAppIDs: UInt32): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamAppList_GetAppName(APISteamAppList: PISteamAppList; nAppID: AppId_t; pchName: PAnsiChar; cchNameMax: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamAppList_GetAppInstallDir(APISteamAppList: PISteamAppList; nAppID: AppId_t; pchDirectory: PAnsiChar; cchNameMax: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamAppList_GetAppBuildId(APISteamAppList: PISteamAppList; nAppID: AppId_t): Integer; cdecl; external STEAMLIB;

function SteamAPI_ISteamHTMLSurface_Init(APISteamHTMLSurface: PISteamHTMLSurface): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTMLSurface_Shutdown(APISteamHTMLSurface: PISteamHTMLSurface): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamHTMLSurface_CreateBrowser(APISteamHTMLSurface: PISteamHTMLSurface; pchUserAgent: PAnsiChar; pchUserCSS: PAnsiChar): SteamAPICall_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_RemoveBrowser(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_LoadURL(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; pchURL: PAnsiChar; pchPostData: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_SetSize(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; unWidth: UInt32; unHeight: UInt32); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_StopLoad(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_Reload(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_GoBack(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_GoForward(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_AddHeader(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; pchKey: PAnsiChar; pchValue: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_ExecuteJavascript(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; pchScript: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_MouseUp(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; eMouseButton: ISteamHTMLSurface__EHTMLMouseButton); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_MouseDown(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; eMouseButton: ISteamHTMLSurface__EHTMLMouseButton); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_MouseDoubleClick(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; eMouseButton: ISteamHTMLSurface__EHTMLMouseButton); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_MouseMove(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; x: Integer; y: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_MouseWheel(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; nDelta: Int32); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_KeyDown(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; nNativeKeyCode: UInt32; eHTMLKeyModifiers: ISteamHTMLSurface__EHTMLKeyModifiers; bIsSystemKey: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_KeyUp(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; nNativeKeyCode: UInt32; eHTMLKeyModifiers: ISteamHTMLSurface__EHTMLKeyModifiers); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_KeyChar(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; cUnicodeChar: UInt32; eHTMLKeyModifiers: ISteamHTMLSurface__EHTMLKeyModifiers); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_SetHorizontalScroll(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; nAbsolutePixelScroll: UInt32); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_SetVerticalScroll(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; nAbsolutePixelScroll: UInt32); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_SetKeyFocus(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; bHasKeyFocus: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_ViewSource(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_CopyToClipboard(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_PasteFromClipboard(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_Find(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; pchSearchStr: PAnsiChar; bCurrentlyInFind: Boolean; bReverse: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_StopFind(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_GetLinkAtPosition(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; x: Integer; y: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_SetCookie(APISteamHTMLSurface: PISteamHTMLSurface; pchHostname: PAnsiChar; pchKey: PAnsiChar; pchValue: PAnsiChar; pchPath: PAnsiChar; nExpires: RTime32; bSecure: Boolean; bHTTPOnly: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_SetPageScaleFactor(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; flZoom: Single; nPointX: Integer; nPointY: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_SetBackgroundMode(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; bBackgroundMode: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_SetDPIScalingFactor(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; flDPIScaling: Single); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_OpenDeveloperTools(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_AllowStartRequest(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; bAllowed: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_JSDialogResponse(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; bResult: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamHTMLSurface_FileLoadDialogResponse(APISteamHTMLSurface: PISteamHTMLSurface; unBrowserHandle: HHTMLBrowser; pchSelectedFiles: PPAnsiChar); cdecl; external STEAMLIB;

function SteamAPI_ISteamInventory_GetResultStatus(APISteamInventory: PISteamInventory; resultHandle: SteamInventoryResult_t): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetResultItems(APISteamInventory: PISteamInventory; resultHandle: SteamInventoryResult_t; pOutItemsArray: PSteamItemDetails_t; punOutItemsArraySize: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetResultItemProperty(APISteamInventory: PISteamInventory; resultHandle: SteamInventoryResult_t; unItemIndex: UInt32; pchPropertyName: PAnsiChar; pchValueBuffer: PAnsiChar; punValueBufferSizeOut: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetResultTimestamp(APISteamInventory: PISteamInventory; resultHandle: SteamInventoryResult_t): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_CheckResultSteamID(APISteamInventory: PISteamInventory; resultHandle: SteamInventoryResult_t; steamIDExpected: CSteamID): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInventory_DestroyResult(APISteamInventory: PISteamInventory; resultHandle: SteamInventoryResult_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetAllItems(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetItemsByID(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; pInstanceIDs: PSteamItemInstanceID_t; unCountInstanceIDs: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_SerializeResult(APISteamInventory: PISteamInventory; resultHandle: SteamInventoryResult_t; pOutBuffer: Pointer; punOutBufferSize: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_DeserializeResult(APISteamInventory: PISteamInventory; pOutResultHandle: PSteamInventoryResult_t; pBuffer: Pointer; unBufferSize: UInt32; bRESERVED_MUST_BE_FALSE: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GenerateItems(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; pArrayItemDefs: PSteamItemDef_t; punArrayQuantity: PUInt32; unArrayLength: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GrantPromoItems(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_AddPromoItem(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; itemDef: SteamItemDef_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_AddPromoItems(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; pArrayItemDefs: PSteamItemDef_t; unArrayLength: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_ConsumeItem(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; itemConsume: SteamItemInstanceID_t; unQuantity: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_ExchangeItems(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; pArrayGenerate: PSteamItemDef_t; punArrayGenerateQuantity: PUInt32; unArrayGenerateLength: UInt32; pArrayDestroy: PSteamItemInstanceID_t; punArrayDestroyQuantity: PUInt32; unArrayDestroyLength: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_TransferItemQuantity(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; itemIdSource: SteamItemInstanceID_t; unQuantity: UInt32; itemIdDest: SteamItemInstanceID_t): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamInventory_SendItemDropHeartbeat(APISteamInventory: PISteamInventory); cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_TriggerItemDrop(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; dropListDefinition: SteamItemDef_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_TradeItems(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; steamIDTradePartner: CSteamID; pArrayGive: PSteamItemInstanceID_t; pArrayGiveQuantity: PUInt32; nArrayGiveLength: UInt32; pArrayGet: PSteamItemInstanceID_t; pArrayGetQuantity: PUInt32; nArrayGetLength: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_LoadItemDefinitions(APISteamInventory: PISteamInventory): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetItemDefinitionIDs(APISteamInventory: PISteamInventory; pItemDefIDs: PSteamItemDef_t; punItemDefIDsArraySize: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetItemDefinitionProperty(APISteamInventory: PISteamInventory; iDefinition: SteamItemDef_t; pchPropertyName: PAnsiChar; pchValueBuffer: PAnsiChar; punValueBufferSizeOut: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_RequestEligiblePromoItemDefinitionsIDs(APISteamInventory: PISteamInventory; steamID: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetEligiblePromoItemDefinitionIDs(APISteamInventory: PISteamInventory; steamID: CSteamID; pItemDefIDs: PSteamItemDef_t; punItemDefIDsArraySize: PUInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_StartPurchase(APISteamInventory: PISteamInventory; pArrayItemDefs: PSteamItemDef_t; punArrayQuantity: PUInt32; unArrayLength: UInt32): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_RequestPrices(APISteamInventory: PISteamInventory): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetNumItemsWithPrices(APISteamInventory: PISteamInventory): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetItemsWithPrices(APISteamInventory: PISteamInventory; pArrayItemDefs: PSteamItemDef_t; pCurrentPrices: PUInt64; pBasePrices: PUInt64; unArrayLength: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_GetItemPrice(APISteamInventory: PISteamInventory; iDefinition: SteamItemDef_t; pCurrentPrice: PUInt64; pBasePrice: PUInt64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_StartUpdateProperties(APISteamInventory: PISteamInventory): SteamInventoryUpdateHandle_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_RemoveProperty(APISteamInventory: PISteamInventory; handle: SteamInventoryUpdateHandle_t; nItemID: SteamItemInstanceID_t; pchPropertyName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_SetPropertyString(APISteamInventory: PISteamInventory; handle: SteamInventoryUpdateHandle_t; nItemID: SteamItemInstanceID_t; pchPropertyName: PAnsiChar; pchPropertyValue: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_SetPropertyBool(APISteamInventory: PISteamInventory; handle: SteamInventoryUpdateHandle_t; nItemID: SteamItemInstanceID_t; pchPropertyName: PAnsiChar; bValue: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_SetPropertyInt64(APISteamInventory: PISteamInventory; handle: SteamInventoryUpdateHandle_t; nItemID: SteamItemInstanceID_t; pchPropertyName: PAnsiChar; nValue: Int64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_SetPropertyFloat(APISteamInventory: PISteamInventory; handle: SteamInventoryUpdateHandle_t; nItemID: SteamItemInstanceID_t; pchPropertyName: PAnsiChar; flValue: Single): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_SubmitUpdateProperties(APISteamInventory: PISteamInventory; handle: SteamInventoryUpdateHandle_t; pResultHandle: PSteamInventoryResult_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamInventory_InspectItem(APISteamInventory: PISteamInventory; pResultHandle: PSteamInventoryResult_t; pchItemToken: PAnsiChar): Boolean; cdecl; external STEAMLIB;

procedure SteamAPI_ISteamVideo_GetVideoURL(APISteamVideo: PISteamVideo; unVideoAppID: AppId_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamVideo_IsBroadcasting(APISteamVideo: PISteamVideo; pnNumViewers: PInteger): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamVideo_GetOPFSettings(APISteamVideo: PISteamVideo; unVideoAppID: AppId_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamVideo_GetOPFStringForApp(APISteamVideo: PISteamVideo; unVideoAppID: AppId_t; pchBuffer: PAnsiChar; pnBufferSize: PInt32): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamParentalSettings_BIsParentalLockEnabled(APISteamParentalSettings: PISteamParentalSettings): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParentalSettings_BIsParentalLockLocked(APISteamParentalSettings: PISteamParentalSettings): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParentalSettings_BIsAppBlocked(APISteamParentalSettings: PISteamParentalSettings; nAppID: AppId_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParentalSettings_BIsAppInBlockList(APISteamParentalSettings: PISteamParentalSettings; nAppID: AppId_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParentalSettings_BIsFeatureBlocked(APISteamParentalSettings: PISteamParentalSettings; eFeature: EParentalFeature): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamParentalSettings_BIsFeatureInBlockList(APISteamParentalSettings: PISteamParentalSettings; eFeature: EParentalFeature): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamRemotePlay_GetSessionCount(APISteamRemotePlay: PISteamRemotePlay): UInt32; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemotePlay_GetSessionID(APISteamRemotePlay: PISteamRemotePlay; iSessionIndex: Integer): RemotePlaySessionID_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemotePlay_GetSessionSteamID(APISteamRemotePlay: PISteamRemotePlay; unSessionID: RemotePlaySessionID_t): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemotePlay_GetSessionClientName(APISteamRemotePlay: PISteamRemotePlay; unSessionID: RemotePlaySessionID_t): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemotePlay_GetSessionClientFormFactor(APISteamRemotePlay: PISteamRemotePlay; unSessionID: RemotePlaySessionID_t): ESteamDeviceFormFactor; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemotePlay_BGetSessionClientResolution(APISteamRemotePlay: PISteamRemotePlay; unSessionID: RemotePlaySessionID_t; pnResolutionX: PInteger; pnResolutionY: PInteger): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamRemotePlay_BSendRemotePlayTogetherInvite(APISteamRemotePlay: PISteamRemotePlay; steamIDFriend: CSteamID): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamNetworkingMessages_SendMessageToUser(APISteamNetworkingMessages: PISteamNetworkingMessages; identityRemote: PSteamNetworkingIdentity; pubData: Pointer; cubData: UInt32; nSendFlags: Integer; nRemoteChannel: Integer): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingMessages_ReceiveMessagesOnChannel(APISteamNetworkingMessages: PISteamNetworkingMessages; nLocalChannel: Integer; ppOutMessages: PPSteamNetworkingMessage_t; nMaxMessages: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingMessages_AcceptSessionWithUser(APISteamNetworkingMessages: PISteamNetworkingMessages; identityRemote: PSteamNetworkingIdentity): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingMessages_CloseSessionWithUser(APISteamNetworkingMessages: PISteamNetworkingMessages; identityRemote: PSteamNetworkingIdentity): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingMessages_CloseChannelWithUser(APISteamNetworkingMessages: PISteamNetworkingMessages; identityRemote: PSteamNetworkingIdentity; nLocalChannel: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingMessages_GetSessionConnectionInfo(APISteamNetworkingMessages: PISteamNetworkingMessages; identityRemote: PSteamNetworkingIdentity; pConnectionInfo: PSteamNetConnectionInfo_t; pQuickStatus: PSteamNetConnectionRealTimeStatus_t): ESteamNetworkingConnectionState; cdecl; external STEAMLIB;

function SteamAPI_ISteamNetworkingSockets_CreateListenSocketIP(APISteamNetworkingSockets: PISteamNetworkingSockets; localAddress: PSteamNetworkingIPAddr; nOptions: Integer; pOptions: PSteamNetworkingConfigValue_t): HSteamListenSocket; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ConnectByIPAddress(APISteamNetworkingSockets: PISteamNetworkingSockets; address: PSteamNetworkingIPAddr; nOptions: Integer; pOptions: PSteamNetworkingConfigValue_t): HSteamNetConnection; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_CreateListenSocketP2P(APISteamNetworkingSockets: PISteamNetworkingSockets; nLocalVirtualPort: Integer; nOptions: Integer; pOptions: PSteamNetworkingConfigValue_t): HSteamListenSocket; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ConnectP2P(APISteamNetworkingSockets: PISteamNetworkingSockets; identityRemote: PSteamNetworkingIdentity; nRemoteVirtualPort: Integer; nOptions: Integer; pOptions: PSteamNetworkingConfigValue_t): HSteamNetConnection; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_AcceptConnection(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_CloseConnection(APISteamNetworkingSockets: PISteamNetworkingSockets; hPeer: HSteamNetConnection; nReason: Integer; pszDebug: PAnsiChar; bEnableLinger: Boolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_CloseListenSocket(APISteamNetworkingSockets: PISteamNetworkingSockets; hSocket: HSteamListenSocket): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_SetConnectionUserData(APISteamNetworkingSockets: PISteamNetworkingSockets; hPeer: HSteamNetConnection; nUserData: Int64): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetConnectionUserData(APISteamNetworkingSockets: PISteamNetworkingSockets; hPeer: HSteamNetConnection): Int64; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingSockets_SetConnectionName(APISteamNetworkingSockets: PISteamNetworkingSockets; hPeer: HSteamNetConnection; pszName: PAnsiChar); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetConnectionName(APISteamNetworkingSockets: PISteamNetworkingSockets; hPeer: HSteamNetConnection; pszName: PAnsiChar; nMaxLen: Integer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_SendMessageToConnection(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection; pData: Pointer; cbData: UInt32; nSendFlags: Integer; pOutMessageNumber: PInt64): EResult; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingSockets_SendMessages(APISteamNetworkingSockets: PISteamNetworkingSockets; nMessages: Integer; pMessages: PPSteamNetworkingMessage_t; pOutMessageNumberOrResult: PInt64); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_FlushMessagesOnConnection(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ReceiveMessagesOnConnection(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection; ppOutMessages: PPSteamNetworkingMessage_t; nMaxMessages: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetConnectionInfo(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection; pInfo: PSteamNetConnectionInfo_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetConnectionRealTimeStatus(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection; pStatus: PSteamNetConnectionRealTimeStatus_t; nLanes: Integer; pLanes: PSteamNetConnectionRealTimeLaneStatus_t): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetDetailedConnectionStatus(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection; pszBuf: PAnsiChar; cbBuf: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetListenSocketAddress(APISteamNetworkingSockets: PISteamNetworkingSockets; hSocket: HSteamListenSocket; address: PSteamNetworkingIPAddr): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_CreateSocketPair(APISteamNetworkingSockets: PISteamNetworkingSockets; pOutConnection1: PHSteamNetConnection; pOutConnection2: PHSteamNetConnection; bUseNetworkLoopback: Boolean; pIdentity1: PSteamNetworkingIdentity; pIdentity2: PSteamNetworkingIdentity): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ConfigureConnectionLanes(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection; nNumLanes: Integer; pLanePriorities: PInteger; pLaneWeights: PUInt16): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetIdentity(APISteamNetworkingSockets: PISteamNetworkingSockets; pIdentity: PSteamNetworkingIdentity): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_InitAuthentication(APISteamNetworkingSockets: PISteamNetworkingSockets): ESteamNetworkingAvailability; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetAuthenticationStatus(APISteamNetworkingSockets: PISteamNetworkingSockets; pDetails: PSteamNetAuthenticationStatus_t): ESteamNetworkingAvailability; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_CreatePollGroup(APISteamNetworkingSockets: PISteamNetworkingSockets): HSteamNetPollGroup; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_DestroyPollGroup(APISteamNetworkingSockets: PISteamNetworkingSockets; hPollGroup: HSteamNetPollGroup): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_SetConnectionPollGroup(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection; hPollGroup: HSteamNetPollGroup): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ReceiveMessagesOnPollGroup(APISteamNetworkingSockets: PISteamNetworkingSockets; hPollGroup: HSteamNetPollGroup; ppOutMessages: PPSteamNetworkingMessage_t; nMaxMessages: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ReceivedRelayAuthTicket(APISteamNetworkingSockets: PISteamNetworkingSockets; pvTicket: Pointer; cbTicket: Integer; pOutParsedTicket: PSteamDatagramRelayAuthTicket): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_FindRelayAuthTicketForServer(APISteamNetworkingSockets: PISteamNetworkingSockets; identityGameServer: PSteamNetworkingIdentity; nRemoteVirtualPort: Integer; pOutParsedTicket: PSteamDatagramRelayAuthTicket): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ConnectToHostedDedicatedServer(APISteamNetworkingSockets: PISteamNetworkingSockets; identityTarget: PSteamNetworkingIdentity; nRemoteVirtualPort: Integer; nOptions: Integer; pOptions: PSteamNetworkingConfigValue_t): HSteamNetConnection; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetHostedDedicatedServerPort(APISteamNetworkingSockets: PISteamNetworkingSockets): UInt16; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetHostedDedicatedServerPOPID(APISteamNetworkingSockets: PISteamNetworkingSockets): SteamNetworkingPOPID; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetHostedDedicatedServerAddress(APISteamNetworkingSockets: PISteamNetworkingSockets; pRouting: PSteamDatagramHostedAddress): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_CreateHostedDedicatedServerListenSocket(APISteamNetworkingSockets: PISteamNetworkingSockets; nLocalVirtualPort: Integer; nOptions: Integer; pOptions: PSteamNetworkingConfigValue_t): HSteamListenSocket; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetGameCoordinatorServerLogin(APISteamNetworkingSockets: PISteamNetworkingSockets; pLoginInfo: PSteamDatagramGameCoordinatorServerLogin; pcbSignedBlob: PInteger; pBlob: Pointer): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ConnectP2PCustomSignaling(APISteamNetworkingSockets: PISteamNetworkingSockets; pSignaling: PISteamNetworkingConnectionSignaling; pPeerIdentity: PSteamNetworkingIdentity; nRemoteVirtualPort: Integer; nOptions: Integer; pOptions: PSteamNetworkingConfigValue_t): HSteamNetConnection; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_ReceivedP2PCustomSignal(APISteamNetworkingSockets: PISteamNetworkingSockets; pMsg: Pointer; cbMsg: Integer; pContext: PISteamNetworkingSignalingRecvContext): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetCertificateRequest(APISteamNetworkingSockets: PISteamNetworkingSockets; pcbBlob: PInteger; pBlob: Pointer; errMsg: PSteamNetworkingErrMsg): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_SetCertificate(APISteamNetworkingSockets: PISteamNetworkingSockets; pCertificate: Pointer; cbCertificate: Integer; errMsg: PSteamNetworkingErrMsg): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingSockets_ResetIdentity(APISteamNetworkingSockets: PISteamNetworkingSockets; pIdentity: PSteamNetworkingIdentity); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingSockets_RunCallbacks(APISteamNetworkingSockets: PISteamNetworkingSockets); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_BeginAsyncRequestFakeIP(APISteamNetworkingSockets: PISteamNetworkingSockets; nNumPorts: Integer): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingSockets_GetFakeIP(APISteamNetworkingSockets: PISteamNetworkingSockets; idxFirstPort: Integer; pInfo: PSteamNetworkingFakeIPResult_t); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_CreateListenSocketP2PFakeIP(APISteamNetworkingSockets: PISteamNetworkingSockets; idxFakePort: Integer; nOptions: Integer; pOptions: PSteamNetworkingConfigValue_t): HSteamListenSocket; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_GetRemoteFakeIPForConnection(APISteamNetworkingSockets: PISteamNetworkingSockets; hConn: HSteamNetConnection; pOutAddr: PSteamNetworkingIPAddr): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingSockets_CreateFakeUDPPort(APISteamNetworkingSockets: PISteamNetworkingSockets; idxFakeServerPort: Integer): PISteamNetworkingFakeUDPPort; cdecl; external STEAMLIB;

function SteamAPI_ISteamNetworkingUtils_AllocateMessage(APISteamNetworkingUtils: PISteamNetworkingUtils; cbAllocateBuffer: Integer): PSteamNetworkingMessage_t; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingUtils_InitRelayNetworkAccess(APISteamNetworkingUtils: PISteamNetworkingUtils); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetRelayNetworkStatus(APISteamNetworkingUtils: PISteamNetworkingUtils; pDetails: PSteamRelayNetworkStatus_t): ESteamNetworkingAvailability; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetLocalPingLocation(APISteamNetworkingUtils: PISteamNetworkingUtils; aResult: PSteamNetworkPingLocation_t): Single; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_EstimatePingTimeBetweenTwoLocations(APISteamNetworkingUtils: PISteamNetworkingUtils; location1: PSteamNetworkPingLocation_t; location2: PSteamNetworkPingLocation_t): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_EstimatePingTimeFromLocalHost(APISteamNetworkingUtils: PISteamNetworkingUtils; remoteLocation: PSteamNetworkPingLocation_t): Integer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingUtils_ConvertPingLocationToString(APISteamNetworkingUtils: PISteamNetworkingUtils; location: PSteamNetworkPingLocation_t; pszBuf: PAnsiChar; cchBufSize: Integer); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_ParsePingLocationString(APISteamNetworkingUtils: PISteamNetworkingUtils; pszString: PAnsiChar; aResult: PSteamNetworkPingLocation_t): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_CheckPingDataUpToDate(APISteamNetworkingUtils: PISteamNetworkingUtils; flMaxAgeSeconds: Single): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetPingToDataCenter(APISteamNetworkingUtils: PISteamNetworkingUtils; popID: SteamNetworkingPOPID; pViaRelayPoP: PSteamNetworkingPOPID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetDirectPingToPOP(APISteamNetworkingUtils: PISteamNetworkingUtils; popID: SteamNetworkingPOPID): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetPOPCount(APISteamNetworkingUtils: PISteamNetworkingUtils): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetPOPList(APISteamNetworkingUtils: PISteamNetworkingUtils; list: PSteamNetworkingPOPID; nListSz: Integer): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetLocalTimestamp(APISteamNetworkingUtils: PISteamNetworkingUtils): SteamNetworkingMicroseconds; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingUtils_SetDebugOutputFunction(APISteamNetworkingUtils: PISteamNetworkingUtils; eDetailLevel: ESteamNetworkingSocketsDebugOutputType; pfnFunc: FSteamNetworkingSocketsDebugOutput); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_IsFakeIPv4(APISteamNetworkingUtils: PISteamNetworkingUtils; nIPv4: UInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetIPv4FakeIPType(APISteamNetworkingUtils: PISteamNetworkingUtils; nIPv4: UInt32): ESteamNetworkingFakeIPType; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetRealIdentityForFakeIP(APISteamNetworkingUtils: PISteamNetworkingUtils; fakeIP: PSteamNetworkingIPAddr; pOutRealIdentity: PSteamNetworkingIdentity): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValueInt32(APISteamNetworkingUtils: PISteamNetworkingUtils; eValue: ESteamNetworkingConfigValue; value: Int32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValueFloat(APISteamNetworkingUtils: PISteamNetworkingUtils; eValue: ESteamNetworkingConfigValue; value: Single): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValueString(APISteamNetworkingUtils: PISteamNetworkingUtils; eValue: ESteamNetworkingConfigValue; value: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValuePtr(APISteamNetworkingUtils: PISteamNetworkingUtils; eValue: ESteamNetworkingConfigValue; value: Pointer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetConnectionConfigValueInt32(APISteamNetworkingUtils: PISteamNetworkingUtils; hConn: HSteamNetConnection; eValue: ESteamNetworkingConfigValue; value: Int32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetConnectionConfigValueFloat(APISteamNetworkingUtils: PISteamNetworkingUtils; hConn: HSteamNetConnection; eValue: ESteamNetworkingConfigValue; value: Single): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetConnectionConfigValueString(APISteamNetworkingUtils: PISteamNetworkingUtils; hConn: HSteamNetConnection; eValue: ESteamNetworkingConfigValue; value: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamNetConnectionStatusChanged(APISteamNetworkingUtils: PISteamNetworkingUtils; fnCallback: FnSteamNetConnectionStatusChanged): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamNetAuthenticationStatusChanged(APISteamNetworkingUtils: PISteamNetworkingUtils; fnCallback: FnSteamNetAuthenticationStatusChanged): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamRelayNetworkStatusChanged(APISteamNetworkingUtils: PISteamNetworkingUtils; fnCallback: FnSteamRelayNetworkStatusChanged): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_FakeIPResult(APISteamNetworkingUtils: PISteamNetworkingUtils; fnCallback: FnSteamNetworkingFakeIPResult): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_MessagesSessionRequest(APISteamNetworkingUtils: PISteamNetworkingUtils; fnCallback: FnSteamNetworkingMessagesSessionRequest): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_MessagesSessionFailed(APISteamNetworkingUtils: PISteamNetworkingUtils; fnCallback: FnSteamNetworkingMessagesSessionFailed): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetConfigValue(APISteamNetworkingUtils: PISteamNetworkingUtils; eValue: ESteamNetworkingConfigValue; eScopeType: ESteamNetworkingConfigScope; scopeObj: IntPtr; eDataType: ESteamNetworkingConfigDataType; pArg: Pointer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SetConfigValueStruct(APISteamNetworkingUtils: PISteamNetworkingUtils; opt: PSteamNetworkingConfigValue_t; eScopeType: ESteamNetworkingConfigScope; scopeObj: IntPtr): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetConfigValue(APISteamNetworkingUtils: PISteamNetworkingUtils; eValue: ESteamNetworkingConfigValue; eScopeType: ESteamNetworkingConfigScope; scopeObj: IntPtr; pOutDataType: PESteamNetworkingConfigDataType; pResult: Pointer; cbResult: Pcsize_t): ESteamNetworkingGetConfigValueResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_GetConfigValueInfo(APISteamNetworkingUtils: PISteamNetworkingUtils; eValue: ESteamNetworkingConfigValue; pOutDataType: PESteamNetworkingConfigDataType; pOutScope: PESteamNetworkingConfigScope): PAnsiChar; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_IterateGenericEditableConfigValues(APISteamNetworkingUtils: PISteamNetworkingUtils; eCurrent: ESteamNetworkingConfigValue; bEnumerateDevVars: Boolean): ESteamNetworkingConfigValue; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_ToString(APISteamNetworkingUtils: PISteamNetworkingUtils; addr: PSteamNetworkingIPAddr; buf: PAnsiChar; cbBuf: UInt32; bWithPort: Boolean); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_ParseString(APISteamNetworkingUtils: PISteamNetworkingUtils; pAddr: PSteamNetworkingIPAddr; pszStr: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_GetFakeIPType(APISteamNetworkingUtils: PISteamNetworkingUtils; addr: PSteamNetworkingIPAddr): ESteamNetworkingFakeIPType; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingUtils_SteamNetworkingIdentity_ToString(APISteamNetworkingUtils: PISteamNetworkingUtils; identity: PSteamNetworkingIdentity; buf: PAnsiChar; cbBuf: UInt32); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingUtils_SteamNetworkingIdentity_ParseString(APISteamNetworkingUtils: PISteamNetworkingUtils; pIdentity: PSteamNetworkingIdentity; pszStr: PAnsiChar): Boolean; cdecl; external STEAMLIB;

procedure SteamAPI_ISteamGameServer_SetProduct(APISteamGameServer: PISteamGameServer; pszProduct: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetGameDescription(APISteamGameServer: PISteamGameServer; pszGameDescription: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetModDir(APISteamGameServer: PISteamGameServer; pszModDir: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetDedicatedServer(APISteamGameServer: PISteamGameServer; bDedicated: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_LogOn(APISteamGameServer: PISteamGameServer; pszToken: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_LogOnAnonymous(APISteamGameServer: PISteamGameServer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_LogOff(APISteamGameServer: PISteamGameServer); cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_BLoggedOn(APISteamGameServer: PISteamGameServer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_BSecure(APISteamGameServer: PISteamGameServer): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_GetSteamID(APISteamGameServer: PISteamGameServer): CSteamID; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_WasRestartRequested(APISteamGameServer: PISteamGameServer): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetMaxPlayerCount(APISteamGameServer: PISteamGameServer; cPlayersMax: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetBotPlayerCount(APISteamGameServer: PISteamGameServer; cBotplayers: Integer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetServerName(APISteamGameServer: PISteamGameServer; pszServerName: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetMapName(APISteamGameServer: PISteamGameServer; pszMapName: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetPasswordProtected(APISteamGameServer: PISteamGameServer; bPasswordProtected: Boolean); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetSpectatorPort(APISteamGameServer: PISteamGameServer; unSpectatorPort: UInt16); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetSpectatorServerName(APISteamGameServer: PISteamGameServer; pszSpectatorServerName: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_ClearAllKeyValues(APISteamGameServer: PISteamGameServer); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetKeyValue(APISteamGameServer: PISteamGameServer; pKey: PAnsiChar; pValue: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetGameTags(APISteamGameServer: PISteamGameServer; pchGameTags: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetGameData(APISteamGameServer: PISteamGameServer; pchGameData: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetRegion(APISteamGameServer: PISteamGameServer; pszRegion: PAnsiChar); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SetAdvertiseServerActive(APISteamGameServer: PISteamGameServer; bActive: Boolean); cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_GetAuthSessionTicket(APISteamGameServer: PISteamGameServer; pTicket: Pointer; cbMaxTicket: Integer; pcbTicket: PUInt32): HAuthTicket; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_BeginAuthSession(APISteamGameServer: PISteamGameServer; pAuthTicket: Pointer; cbAuthTicket: Integer; steamID: CSteamID): EBeginAuthSessionResult; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_EndAuthSession(APISteamGameServer: PISteamGameServer; steamID: CSteamID); cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_CancelAuthTicket(APISteamGameServer: PISteamGameServer; hAuthTicket: HAuthTicket); cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_UserHasLicenseForApp(APISteamGameServer: PISteamGameServer; steamID: CSteamID; appID: AppId_t): EUserHasLicenseForAppResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_RequestUserGroupStatus(APISteamGameServer: PISteamGameServer; steamIDUser: CSteamID; steamIDGroup: CSteamID): Boolean; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_GetGameplayStats(APISteamGameServer: PISteamGameServer); cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_GetServerReputation(APISteamGameServer: PISteamGameServer): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_GetPublicIP(APISteamGameServer: PISteamGameServer): SteamIPAddress_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_HandleIncomingPacket(APISteamGameServer: PISteamGameServer; pData: Pointer; cbData: Integer; srcIP: UInt32; srcPort: UInt16): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_GetNextOutgoingPacket(APISteamGameServer: PISteamGameServer; pOut: Pointer; cbMaxOut: Integer; pNetAdr: PUInt32; pPort: PUInt16): Integer; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_AssociateWithClan(APISteamGameServer: PISteamGameServer; steamIDClan: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_ComputeNewPlayerCompatibility(APISteamGameServer: PISteamGameServer; steamIDNewPlayer: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_SendUserConnectAndAuthenticate_DEPRECATED(APISteamGameServer: PISteamGameServer; unIPClient: UInt32; pvAuthBlob: Pointer; cubAuthBlobSize: UInt32; pSteamIDUser: PCSteamID): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_CreateUnauthenticatedUserConnection(APISteamGameServer: PISteamGameServer): CSteamID; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamGameServer_SendUserDisconnect_DEPRECATED(APISteamGameServer: PISteamGameServer; steamIDUser: CSteamID); cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServer_BUpdateUserData(APISteamGameServer: PISteamGameServer; steamIDUser: CSteamID; pchPlayerName: PAnsiChar; uScore: UInt32): Boolean; cdecl; external STEAMLIB;

function SteamAPI_ISteamGameServerStats_RequestUserStats(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_GetUserStatInt32(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID; pchName: PAnsiChar; pData: PInt32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_GetUserStatFloat(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID; pchName: PAnsiChar; pData: PSingle): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_GetUserAchievement(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID; pchName: PAnsiChar; pbAchieved: PBoolean): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_SetUserStatInt32(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID; pchName: PAnsiChar; nData: Int32): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_SetUserStatFloat(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID; pchName: PAnsiChar; fData: Single): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_UpdateUserAvgRateStat(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID; pchName: PAnsiChar; flCountThisSession: Single; dSessionLength: Double): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_SetUserAchievement(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID; pchName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_ClearUserAchievement(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID; pchName: PAnsiChar): Boolean; cdecl; external STEAMLIB;
function SteamAPI_ISteamGameServerStats_StoreUserStats(APISteamGameServerStats: PISteamGameServerStats; steamIDUser: CSteamID): SteamAPICall_t; cdecl; external STEAMLIB;

procedure SteamAPI_ISteamNetworkingFakeUDPPort_DestroyFakeUDPPort(APISteamNetworkingFakeUDPPort: PISteamNetworkingFakeUDPPort); cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingFakeUDPPort_SendMessageToFakeIP(APISteamNetworkingFakeUDPPort: PISteamNetworkingFakeUDPPort; remoteAddress: PSteamNetworkingIPAddr; pData: Pointer; cbData: UInt32; nSendFlags: Integer): EResult; cdecl; external STEAMLIB;
function SteamAPI_ISteamNetworkingFakeUDPPort_ReceiveMessages(APISteamNetworkingFakeUDPPort: PISteamNetworkingFakeUDPPort; ppOutMessages: PPSteamNetworkingMessage_t; nMaxMessages: Integer): Integer; cdecl; external STEAMLIB;
procedure SteamAPI_ISteamNetworkingFakeUDPPort_ScheduleCleanup(APISteamNetworkingFakeUDPPort: PISteamNetworkingFakeUDPPort; remoteAddress: PSteamNetworkingIPAddr); cdecl; external STEAMLIB;
